...
if (typeof Blockly !== 'undefined') {
  ...
  var FieldMatrix3x3Color = /*#__PURE__*/function (_Blockly$Field) {
    ...
    function FieldMatrix3x3Color(value, validator) {
      ...
      _this = _callSuper(this, FieldMatrix3x3Color, [value, validator]);

      // LEGO 3x3 matrix colors (protocol defined by LEGO firmware)
      _this.colors_ = ['#222222',
      // 0: off (dark gray)
      '#FF00FF',
      // 1: magenta
      '#8000FF',
      ...
      _this.colorNames_ = ['off', 'magenta', 'violet', 'blue', 'turquoise', 'mint', 'green', 'yellow', 'orange', 'red', 'white'];

      // Current matrix state: 9 pixels, each with colorId + brightness
      _this.matrix_ = Array(9).fill().map(function () {
        return {
          colorId: 0,
          brightness: 5
        };
      ...
      _this.selectedColor_ = 9; // Default to red
      _this.selectedBrightness_ = 5; // Default brightness (1-10 scale)
      _this.isDropdownVisible_ = false;

      // Set default heart pattern if no value provided
      _this.setValue(value || '960000960960a60960960000960');
      return _this;
    }
    ...
    _createClass(FieldMatrix3x3Color, [{
      ...
      value: function createColorButton_(parent, colorId, x, y) {
        ...
        Blockly.bindEventWithChecks_(btn, 'mousedown', this, function (e) {
          _this3.selectedColor_ = colorId;
          _this3.updateColorButtons_();
          e.stopPropagation();
        });
        return btn;
      }
      ...
      value: function createBrightnessControl_(parent, x, y) {
        ...
        Blockly.bindEventWithChecks_(bg, 'mousedown', this, function (e) {
          ...
          _this4.selectedBrightness_ = Math.max(1, Math.min(10, Math.round((20 - clickY) / 2)));
          _this4.updateBrightnessControl_();
          e.stopPropagation();
        });
      }
      ...
      value: function updateColorButtons_() {
        ...
        buttons.forEach(function (btn) {
          ...
          if (colorId === _this5.selectedColor_) {
      ...
      value: function updateMatrix_() {
        ...
        this.matrix_.forEach(function (pixel, index) {
          _this6.setCellColor_(index, pixel.colorId, pixel.brightness);
        });
      }
  ...
  }(Blockly.Field); // ✅ MODERN FIELD REGISTRATION - Compatible with xcratch
  // Use the current Blockly field registry API instead of deprecated methods
  try {
...
var SpikePrime = /*#__PURE__*/function () {
  function SpikePrime(runtime, extensionId) {
    ...
    setInterval(function () {
      _this7._timer.current = (Date.now() - _this7._timer.start) / 1000;
    }, 10);
  }
  ...
  _createClass(SpikePrime, [{
    ...
    value: function _onConnect() {
      ...
      setTimeout(function () {
        ...
        _this9.sendRaw('import hub\r\nprint("PYTHON_AVAILABLE")\r\n');
        // Re-request initial state data
        _this9.sendCommand('trigger_current_state', {}, false);
      ...
      try {
        if (dataText.startsWith('SENSORS:')) {
          ...
          if (this._sensors.gestures.hasOwnProperty(gesture)) {
            ...
            setTimeout(function () {
              _this10._sensors.gestures[gesture] = false;
            }, 100);
          }
    ...
    value: function _parseEventResponse(response) {
      ...
      if (gestureMap[response.p]) {
        ...
        setTimeout(function () {
          _this11._sensors.gestures[gestureMap[response.p]] = false;
        }, 100);
      }
    }
  }]);
