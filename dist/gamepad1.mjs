...
var Scratch3GamepadBlocks = /*#__PURE__*/function () {
  ...
  _createClass(Scratch3GamepadBlocks, [{
    ...
    value: function getAxisValue(args) {
      ...
      if (!stick) return 0;
      var axisIndex = stick[args.AXIS];
      var value = this.activeController.axes[axisIndex] || 0;

      // Apply a small "deadzone" to prevent drift from worn-out controllers
