    ...
    value: function connect(id) {
      ...
      if (this._bt) {
        ...
        this._connectionTimeout = setTimeout(function () {
          ...
          console.log('   1. Controller is not paired in Windows Settings');
          console.log('   2. Controller is already connected to another device');
          console.log('   3. Controller is sleeping - press PS button to wake it');
          console.log('   4. Scratch Link is not running properly');
          _this._connected = false;
