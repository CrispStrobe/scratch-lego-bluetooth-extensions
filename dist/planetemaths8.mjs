 ...
 * @type {string}
 */
var blockIconURI = 'data:image/svg+xml;base64,[YOUR_ORIGINAL_ICON_HERE]';
...
// Setup formatMessage with translations immediately
formatMessage.setup({
  locale: 'en',
  // Default to English, will be overridden by Scratch's locale
...
var Scratch3PMBlocks = /*#__PURE__*/function () {
  ...
  _createClass(Scratch3PMBlocks, [{
    ...
    value: function setupTranslations() {
      // Initialize formatMessage with all available translations
      formatMessage.setup({
    ...
    value: function getLocale() {
      // Try to get locale from runtime, fallback to 'en'
    ...
    value: function getInfo() {
      return {
        ...
        blocks: [{
          ...
          text: formatMessage({
            id: 'pm.random',
            default: 'random number from [NUM1] to [NUM2]',
            description: ''
          }),
          blockType: BlockType.REPORTER,
          arguments: {
