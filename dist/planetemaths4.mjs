...
var Scratch3PMBlocks = /*#__PURE__*/function () {
  function Scratch3PMBlocks(runtime) {
    ...
    // The formatMessage utility must be initialized here and passed to getInfo
    formatMessage.setup({
      locale: 'en',
      translations: {
        en: extensionTranslations.en // Optional: provide English defaults if needed
      }
    });
  }
  _createClass(Scratch3PMBlocks, [{
    ...
    value: function setupTranslations() {
      ...
      for (var locale in extensionTranslations) {
