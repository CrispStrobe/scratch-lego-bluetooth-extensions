...
// Use the official LEGO Education BLE Service UUID for Scratch
var BLE_SERVICE_ID = '00001623-1212-efde-1623-785feabcd123';
// The characteristic for sending and receiving messages
var BLE_CHARACTERISTIC_ID = '00001624-1212-efde-1623-785feabcd123';
...
var SpikePrime = /*#__PURE__*/function () {
  ...
  _createClass(SpikePrime, [{
    ...
    value: function scan() {
      ...
      try {
        // CORRECTED BLE INITIALIZATION
        this._ble = new BLE(this._runtime, this._extensionId, {
          // Use a simple, reliable filter
          filters: [{
            services: [BLE_SERVICE_ID]
          }],
          optionalServices: []
        }, this._onConnect, this.reset, this._onMessage, BLE_CHARACTERISTIC_ID); // <-- THE CRITICAL FIX IS HERE
      } catch (error) {
