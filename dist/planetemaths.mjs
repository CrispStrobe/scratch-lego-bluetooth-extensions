...
function require_planetemaths() {
  if (hasRequired_planetemaths) return _planetemaths;
  ...
  _planetemaths.blockClass = Scratch3GamepadBlocks;
  _planetemaths.blockClass = Scratch3PMBlocks;
  return _planetemaths;
}
