...
_legoble.exports;
var hasRequired_legoble;
function require_legoble() {
  if (hasRequired_legoble) return _legoble.exports;
  hasRequired_legoble = 1;
  (function (module, exports) {
    ...
    var Scratch3LegoBleBlocks = /*#__PURE__*/function (_BleBaseBlocks) {
      function Scratch3LegoBleBlocks(runtime) {
        ...
        _this7 = _callSuper(this, Scratch3LegoBleBlocks, [new Hub(runtime, Scratch3LegoBleBlocks.EXTENSION_ID)]);
