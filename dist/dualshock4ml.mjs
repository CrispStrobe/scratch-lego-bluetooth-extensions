...
var translations$1 = {
  'en': {
    ...
    'gamepad.buttons.LS': 'LS',
    'gamepad.buttons.RS': 'RS',
  ...
  'de': {
    'gamepad.name': 'Universelles Gamepad',
    'gamepad.isConnected': 'Gamepad verbunden?',
    'gamepad.getControllerInfo': 'Controller-Name',
    'gamepad.whenButtonPressed': 'wenn [BUTTON] gedrückt wird',
    'gamepad.isButtonPressed': '[BUTTON] gedrückt?',
    'gamepad.getStickValue': '[STICK] Stick [AXIS]',
    'gamepad.getStickDirection': '[STICK] Stick Richtung',
    'gamepad.getCursorX': 'Cursor x',
    'gamepad.getCursorY': 'Cursor y',
    'gamepad.setCursorPosition': 'Cursor auf x: [X] y: [Y] setzen',
    'gamepad.vibrate': 'vibrieren für [DURATION] ms mit [INTENSITY]%',
    'gamepad.showDebugInfo': 'Gamepad-Debug-Informationen anzeigen',
    'gamepad.buttons.A': 'A',
    'gamepad.buttons.B': 'B',
    'gamepad.buttons.X': 'X',
    'gamepad.buttons.Y': 'Y',
    ...
    'gamepad.buttons.LS': 'LS',
    'gamepad.buttons.RS': 'RS',
    'gamepad.buttons.UP': 'HOCH',
    'gamepad.buttons.DOWN': 'RUNTER',
    'gamepad.buttons.LEFT': 'LINKS',
    'gamepad.buttons.RIGHT': 'RECHTS',
    'gamepad.buttons.HOME': 'HOME',
    'gamepad.sticks.left': 'links',
    'gamepad.sticks.right': 'rechts',
    'gamepad.axes.x': 'x',
    'gamepad.axes.y': 'y'
  },
  'es': {
    'gamepad.name': 'Gamepad Universal',
    'gamepad.isConnected': 'Gamepad conectado?',
    'gamepad.getControllerInfo': 'nombre del mando',
    'gamepad.whenButtonPressed': 'cuando [BUTTON] sea presionado',
    'gamepad.isButtonPressed': '[BUTTON] presionado?',
    'gamepad.getStickValue': '[STICK] stick [AXIS]',
    'gamepad.getStickDirection': 'dirección del stick [STICK]',
    'gamepad.getCursorX': 'cursor x',
    'gamepad.getCursorY': 'cursor y',
    'gamepad.setCursorPosition': 'establecer cursor en x: [X] y: [Y]',
    'gamepad.vibrate': 'vibrar por [DURATION] ms al [INTENSITY]%',
    'gamepad.showDebugInfo': 'mostrar información de depuración del gamepad',
    'gamepad.buttons.A': 'A',
    'gamepad.buttons.B': 'B',
    'gamepad.buttons.X': 'X',
    'gamepad.buttons.Y': 'Y',
    ...
    'gamepad.buttons.LS': 'LS',
    'gamepad.buttons.RS': 'RS',
    'gamepad.buttons.UP': 'ARRIBA',
    'gamepad.buttons.DOWN': 'ABAJO',
    'gamepad.buttons.LEFT': 'IZQUIERDA',
    'gamepad.buttons.RIGHT': 'DERECHA',
    'gamepad.buttons.HOME': 'HOME',
    'gamepad.sticks.left': 'izquierda',
    'gamepad.sticks.right': 'derecha',
    'gamepad.axes.x': 'x',
    'gamepad.axes.y': 'y'
  }
};
...
var Cast = cast;
var translations = translations$1;
...
var Scratch3GamepadBlocks = /*#__PURE__*/function () {
  function Scratch3GamepadBlocks(runtime) {
    ...
    // This is where you set up the translations
    formatMessage.setup({
