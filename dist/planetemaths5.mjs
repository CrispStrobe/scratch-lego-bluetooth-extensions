...
// Define translations in a single, accessible place.
var translations = {
  'de': _defineProperty(_defineProperty({
    'pm.title': 'Mathe',
    'pm.add': '[NUM1] + [NUM2]',
  ...
  'fr': _defineProperty(_defineProperty({
    'pm.title': 'Maths',
    'pm.add': '[NUM1] + [NUM2]',
    'pm.substract': '[NUM1] - [NUM2]',
    'pm.multiply': '[NUM1] x [NUM2]',
...
var Scratch3PMBlocks = /*#__PURE__*/function () {
  function Scratch3PMBlocks(runtime) {
    ...
    // This is the correct place to set up the translations for the instance.
  ...
  _createClass(Scratch3PMBlocks, [{
    ...
    value: function setupTranslations() {
      ...
      if (translations[locale]) {
        formatMessage.addMessages(translations[locale]);
      }
    }
  }, {
    key: "getInfo",
    value: function getInfo() {
      return {
        id: 'planetemaths',
        name: 'Maths Planet',
        // The default name is a simple string. The GUI handles its translation.
        color1: '#4879b7',
        color2: '#000000',
        blocks: [{
          opcode: 'add',
        ...
        // All other blocks are structured similarly...
        {
          opcode: 'substract',
          text: formatMessage({
            id: 'pm.substract',
