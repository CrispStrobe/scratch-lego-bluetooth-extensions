...
var marioBaseBlocks;
var hasRequiredMarioBaseBlocks;
function requireMarioBaseBlocks() {
  if (hasRequiredMarioBaseBlocks) return marioBaseBlocks;
  hasRequiredMarioBaseBlocks = 1;
  ...
  var MarioBaseBlocks = /*#__PURE__*/function () {
    ...
    return _createClass(MarioBaseBlocks, [{
      key: "getBlocks",
  ...
  marioBaseBlocks = MarioBaseBlocks;
...
_legomario.exports;
var hasRequired_legomario;
function require_legomario() {
  if (hasRequired_legomario) return _legomario.exports;
  hasRequired_legomario = 1;
  (function (module, exports) {
    var MarioBaseBlocks = requireMarioBaseBlocks();
    var Hub = requireHub();
    ...
    var Scratch3LegoMarioBlocks = /*#__PURE__*/function (_MarioBaseBlocks) {
      function Scratch3LegoMarioBlocks(runtime) {
        ...
        _this7 = _callSuper(this, Scratch3LegoMarioBlocks, [new Hub(runtime, Scratch3LegoMarioBlocks.EXTENSION_ID, 0x43)]);
    ...
    }(MarioBaseBlocks); // Extension export for bundling
    var ExtensionClass = Scratch3LegoMarioBlocks;
    module.exports = ExtensionClass;
    exports.blockClass = ExtensionClass;
  })(_legomario, _legomario.exports);
  return _legomario.exports;
}
