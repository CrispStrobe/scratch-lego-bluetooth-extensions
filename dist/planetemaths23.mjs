...
var Scratch3PMBlocks = /*#__PURE__*/function () {
  function Scratch3PMBlocks(runtime) {
    ...
    // Primary method for setting translations. This runs when the VM is ready.
    if (this.runtime && this.runtime.getLocale) {
      var locale = this.runtime.getLocale();
      console.log("%cPlaneteMaths Extension: Constructor is setting locale from runtime: \"".concat(locale, "\""), 'color: green; font-weight: bold;');
      formatMessage.setup({
        locale: locale,
        translations: extensionTranslations
      });
    } else {
      console.warn('PlaneteMaths Extension: Runtime not available in constructor.');
    }
  }
  _createClass(Scratch3PMBlocks, [{
    ...
    value: function getInfo() {
      ...
      // Defensive translation setup for environments like XCRatch that call getInfo early.
      if (this.runtime && this.runtime.getLocale) {
        var locale = this.runtime.getLocale();
        formatMessage.setup({
          locale: locale,
      ...
      return {
        ...
        // ✅ Fallback for when constructor runs too early. This is the key change.
