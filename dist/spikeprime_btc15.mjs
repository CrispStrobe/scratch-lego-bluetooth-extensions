...
var Scratch3SpikePrimeBlocks = /*#__PURE__*/function () {
  function Scratch3SpikePrimeBlocks(runtime) {
    ...
    // Field registration has been MOVED from here to getInfo().
    ...
    value: function getInfo() {
      ...
      if (!Scratch3SpikePrimeBlocks.fieldRegistered) {
        ...
        if (typeof Blockly !== 'undefined' && Blockly.Field) {
          ...
          }(Blockly.Field); // ===== END OF FieldMatrix3x3Color CLASS DEFINITION =====
          // Now, register the class we just defined.
          try {
            Blockly.fieldRegistry.register('field_matrix_3x3_color', FieldMatrix3x3Color);
            console.log('✅ Successfully registered field_matrix_3x3_color in getInfo().');
            Scratch3SpikePrimeBlocks.fieldRegistered = true;
          } catch (error) {
            console.error('❌ Matrix 3x3 field registration failed inside getInfo():', error);
          }
        } else {
          console.error('❌ CRITICAL: Blockly object still not available in getInfo().');
        }
      } // --- END OF FIELD REGISTRATION ---
