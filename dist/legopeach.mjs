...
_legopeach.exports;
var hasRequired_legopeach;
function require_legopeach() {
  if (hasRequired_legopeach) return _legopeach.exports;
  hasRequired_legopeach = 1;
  (function (module, exports) {
    ...
    var Scratch3LegoPeachBlocks = /*#__PURE__*/function (_MarioBaseBlocks) {
      function Scratch3LegoPeachBlocks(runtime) {
        ...
        _this7 = _callSuper(this, Scratch3LegoPeachBlocks, [new Hub(runtime, Scratch3LegoPeachBlocks.EXTENSION_ID, 0x45)]);
