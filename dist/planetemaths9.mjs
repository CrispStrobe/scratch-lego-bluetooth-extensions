...
// We no longer need to import formatMessage here, as it's handled by the runtime.

/**
 * Class for the Math Planet blocks.
 * @constructor
 */
var Scratch3PMBlocks = /*#__PURE__*/function () {
  function Scratch3PMBlocks(runtime) {
    ...
    // The runtime's formatMessage is the single source of truth for translations.
    // We pass our translations to it when the extension is initialized.
    if (runtime.setFormatMessage) {
      runtime.setFormatMessage(Scratch3PMBlocks.translations);
    }
  }

  /**
   * All translation data is now a static property of the class.
   * This encapsulates the data and makes the module structure cleaner.
   */
  _createClass(Scratch3PMBlocks, [{
    ...
    function getInfo() {
      return {
        id: 'planetemaths',
        // ✅ FIX: Provide the translation object, don't call formatMessage here.
        name: {
          id: 'pm.title',
        ...
        color2: '#000000',
        blocks: [
        // ✅ FIX: Replaced all `formatMessage({...})` calls with the object itself.
        {
          opcode: 'add',
          text: {
            id: 'pm.add',
        ...
        menus: {
          // ✅ FIX: The same fix is applied to all menu items.
          PARTIE_ENTIERE: {
    ...
    // ... The rest of your functions (add, substract, etc.) remain unchanged ...
  }, {
    key: "add",
    ...
    value: function contains(args) {
      var format = function format(str) {
        return Cast.toString(str).toLowerCase();
      };
