...
var Scratch3SpikePrimeBlocks = /*#__PURE__*/function () {
  ...
  _createClass(Scratch3SpikePrimeBlocks, [{
    ...
    value: function getInfo() {
      ...
      return {
        ...
        menus: {
          ...
          MATRIX_COLOR: {
            acceptReporters: false,
            items: ['off', 'magenta', 'purple', 'blue', 'turquoise', 'mint', 'green', 'yellow', 'orange', 'red', 'white']
          },
          LED_COLOR: {
            acceptReporters: false,
    ...
    key: "motorSetStallDetection",
    value: function motorSetStallDetection(args) {
      var port = Cast.toString(args.PORT).toUpperCase();
      var enable = Cast.toString(args.ENABLE) === 'enabled';
      this._peripheral.motorSettings[port].stallDetection = enable;
    }
  }, {
    key: "motorSetStopMode",
    value: function motorSetStopMode(args) {
      var port = Cast.toString(args.PORT).toUpperCase();
    ...
    key: "setPixelBrightness",
    value: function setPixelBrightness(args) {
      var brightness = MathUtil.clamp(Cast.toNumber(args.BRIGHTNESS), 0, 100);
    ...
    value: function setCenterButtonColor(args) {
      ...
      var pythonCode = "hub.led(".concat(colorValue, ")");
      return this._peripheral.sendPythonCommand(pythonCode);
    }
    ...
    value: function resetYaw(args) {
      ...
      var pythonCode = "hub.motion.yaw_pitch_roll(yaw=".concat(angle, ")");
      return this._peripheral.sendPythonCommand(pythonCode);
    }
    ...
    value: function setDistanceLights(args) {
      ...
      var pythonCode = "distance_sensor('".concat(port, "').light_up(").concat(light1, ", ").concat(light2, ", ").concat(light3, ", ").concat(light4, ")");
      return this._peripheral.sendPythonCommand(pythonCode);
    }
    ...
    value: function setColorLights(args) {
      var port = Cast.toString(args.PORT).toUpperCase();
      var brightness = MathUtil.clamp(Cast.toNumber(args.BRIGHTNESS), 0, 100);
      var pythonCode = "color_sensor('".concat(port, "').light_up(").concat(brightness, ")");
      return this._peripheral.sendPythonCommand(pythonCode);
    }
    ...
    value: function setMatrix3x3Pixel(args) {
      ...
      var color = Cast.toString(args.COLOR);
      var brightness = MathUtil.clamp(Cast.toNumber(args.BRIGHTNESS), 0, 10);
      var pythonCode = "color_matrix('".concat(port, "').set_pixel(").concat(x, ", ").concat(y, ", color='").concat(color, "', brightness=").concat(brightness, ")");
      return this._peripheral.sendPythonCommand(pythonCode);
    }
  }, {
    key: "setMatrix3x3All",
    value: function setMatrix3x3All(args) {
      ...
      var color = Cast.toString(args.COLOR);
      var brightness = MathUtil.clamp(Cast.toNumber(args.BRIGHTNESS), 0, 10);
      var pythonCode = "color_matrix('".concat(port, "').show_color('").concat(color, "', brightness=").concat(brightness, ")");
      return this._peripheral.sendPythonCommand(pythonCode);
    }
  }, {
    key: "clearMatrix3x3",
    value: function clearMatrix3x3(args) {
      var port = Cast.toString(args.PORT).toUpperCase();
      var pythonCode = "color_matrix('".concat(port, "').off()");
      return this._peripheral.sendPythonCommand(pythonCode);
    }
