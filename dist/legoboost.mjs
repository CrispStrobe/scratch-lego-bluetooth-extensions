var en = {
	"gui.extension.legoboost.name": "LEGO Boost Hub Extended",
	"gui.extension.legoboost.description": "Extended extension for LEGO Boost Hub with advanced motor control, multi-sensor support, and enhanced hub monitoring.",
	"gui.extension.legoboost.connectingMessage": "Connecting to LEGO Boost Hub..."
};
var de = {
	"gui.extension.legoboost.name": "LEGO Boost Hub Erweitert",
	"gui.extension.legoboost.description": "Erweiterte Erweiterung für LEGO Boost Hub mit verbesserter Motorsteuerung, Multi-Sensor-Unterstützung und erweiterte Hub-Überwachung.",
	"gui.extension.legoboost.connectingMessage": "Verbinde mit LEGO Boost Hub..."
};
var fr = {
	"gui.extension.legoboost.name": "LEGO Boost Hub Étendu",
	"gui.extension.legoboost.description": "Extension étendue pour LEGO Boost Hub avec contrôle moteur avancé, support multi-capteurs et surveillance améliorée du hub.",
	"gui.extension.legoboost.connectingMessage": "Connexion au LEGO Boost Hub..."
};
var translations$1 = {
	en: en,
	de: de,
...
var translations = {
  "en": {
    "legoboost.motorOnFor": "turn motor [MOTOR_ID] for [DURATION] seconds",
    "legoboost.motorOnForRotation": "turn motor [MOTOR_ID] for [ROTATION] rotations",
    "legoboost.motorRunToPosition": "turn motor [MOTOR_ID] to position [POSITION]",
    "legoboost.motorOn": "turn motor [MOTOR_ID] on",
    "legoboost.motorOff": "turn motor [MOTOR_ID] off",
    "legoboost.setMotorPower": "set motor [MOTOR_ID] speed to [POWER] %",
    "legoboost.setMotorDirection": "set motor [MOTOR_ID] direction [MOTOR_DIRECTION]",
    "legoboost.setMotorStopAction": "set motor [MOTOR_ID] stop action to [ACTION]",
    "legoboost.setMotorAcceleration": "set motor [MOTOR_ID] acceleration to [TIME] ms",
    "legoboost.setMotorDeceleration": "set motor [MOTOR_ID] deceleration to [TIME] ms",
    "legoboost.resetMotorPosition": "reset motor [MOTOR_ID] position to [POSITION]",
    "legoboost.getMotorPosition": "motor [MOTOR_REPORTER_ID] position",
    "legoboost.whenColor": "when [PORT] sees [COLOR] brick",
    "legoboost.seeingColor": "[PORT] seeing [COLOR] brick?",
    "legoboost.getDistance": "[PORT] distance (mm)",
    "legoboost.getReflection": "[PORT] reflection (%)",
    "legoboost.getForce": "[PORT] force (N)",
    "legoboost.isForceSensorPressed": "[PORT] force sensor pressed?",
    "legoboost.whenForceSensorPressed": "when [PORT] force sensor pressed",
    "legoboost.whenTilted": "when tilted [TILT_DIRECTION_ANY]",
    "legoboost.isTilted": "tilted [TILT_DIRECTION_ANY]?",
    "legoboost.getTiltAngle": "tilt angle [TILT_DIRECTION]",
    "legoboost.setLightHue": "set light color to [HUE]",
    "legoboost.shutdown": "shutdown hub",
    "legoboost.whenButtonPressed": "when hub button pressed",
    "legoboost.isButtonPressed": "hub button pressed?",
    "legoboost.getBatteryLevel": "battery level (%)",
    "legoboost.getFirmwareVersion": "firmware version",
    "legoboost.getRSSI": "Bluetooth signal strength",
    "legoboost.whenBatteryLow": "when battery is low",
    "legoboost.whenMotorOverloaded": "when motor overloaded",
    "legoboost.stopAction.float": "float",
    "legoboost.stopAction.brake": "brake",
    "legoboost.stopAction.hold": "hold",
    "legoboost.motorDirection.forward": "this way",
    "legoboost.motorDirection.backward": "that way",
    "legoboost.motorDirection.reverse": "reverse",
    "legoboost.tiltDirection.up": "up",
    "legoboost.tiltDirection.down": "down",
    "legoboost.tiltDirection.left": "left",
    "legoboost.tiltDirection.right": "right",
    "legoboost.tiltDirection.any": "any",
    "legoboost.color.red": "red",
    "legoboost.color.blue": "blue",
    "legoboost.color.green": "green",
    "legoboost.color.yellow": "yellow",
    "legoboost.color.white": "white",
    "legoboost.color.black": "black",
    "legoboost.color.any": "any color"
  },
  "de": {
    "legoboost.motorOnFor": "Motor [MOTOR_ID] für [DURATION] Sekunden einschalten",
    "legoboost.motorOnForRotation": "Motor [MOTOR_ID] für [ROTATION] Umdrehungen drehen",
    "legoboost.motorRunToPosition": "Motor [MOTOR_ID] zu Position [POSITION] drehen",
    "legoboost.motorOn": "Motor [MOTOR_ID] einschalten",
    "legoboost.motorOff": "Motor [MOTOR_ID] ausschalten",
    "legoboost.setMotorPower": "Motor [MOTOR_ID] Geschwindigkeit auf [POWER] % setzen",
    "legoboost.setMotorDirection": "Motor [MOTOR_ID] Richtung [MOTOR_DIRECTION] setzen",
    "legoboost.setMotorStopAction": "Motor [MOTOR_ID] Stopp-Aktion auf [ACTION] setzen",
    "legoboost.setMotorAcceleration": "Motor [MOTOR_ID] Beschleunigung auf [TIME] ms setzen",
    "legoboost.setMotorDeceleration": "Motor [MOTOR_ID] Abbremsung auf [TIME] ms setzen",
    "legoboost.resetMotorPosition": "Motor [MOTOR_ID] Position auf [POSITION] zurücksetzen",
    "legoboost.getMotorPosition": "Motor [MOTOR_REPORTER_ID] Position",
    "legoboost.whenColor": "wenn [PORT] [COLOR] Stein sieht",
    "legoboost.seeingColor": "[PORT] sieht [COLOR] Stein?",
    "legoboost.getDistance": "[PORT] Entfernung (mm)",
    "legoboost.getReflection": "[PORT] Reflexion (%)",
    "legoboost.getForce": "[PORT] Kraft (N)",
    "legoboost.isForceSensorPressed": "[PORT] Kraftsensor gedrückt?",
    "legoboost.whenForceSensorPressed": "wenn [PORT] Kraftsensor gedrückt",
    "legoboost.whenTilted": "wenn [TILT_DIRECTION_ANY] geneigt",
    "legoboost.isTilted": "[TILT_DIRECTION_ANY] geneigt?",
    "legoboost.getTiltAngle": "Neigungswinkel [TILT_DIRECTION]",
    "legoboost.setLightHue": "Lichtfarbe auf [HUE] setzen",
    "legoboost.shutdown": "Hub herunterfahren",
    "legoboost.whenButtonPressed": "wenn Hub-Taste gedrückt",
    "legoboost.isButtonPressed": "Hub-Taste gedrückt?",
    "legoboost.getBatteryLevel": "Batteriestand (%)",
    "legoboost.getFirmwareVersion": "Firmware-Version",
    "legoboost.getRSSI": "Bluetooth-Signalstärke",
    "legoboost.whenBatteryLow": "wenn Batterie schwach",
    "legoboost.whenMotorOverloaded": "wenn Motor überlastet",
    "legoboost.stopAction.float": "treiben lassen",
    "legoboost.stopAction.brake": "bremsen",
    "legoboost.stopAction.hold": "halten",
    "legoboost.motorDirection.forward": "vorwärts",
    "legoboost.motorDirection.backward": "rückwärts",
    "legoboost.motorDirection.reverse": "umkehren",
    "legoboost.tiltDirection.up": "nach oben",
    "legoboost.tiltDirection.down": "nach unten",
    "legoboost.tiltDirection.left": "nach links",
    "legoboost.tiltDirection.right": "nach rechts",
    "legoboost.tiltDirection.any": "irgendwie",
    "legoboost.color.red": "rot",
    "legoboost.color.blue": "blau",
    "legoboost.color.green": "grün",
    "legoboost.color.yellow": "gelb",
    "legoboost.color.white": "weiß",
    "legoboost.color.black": "schwarz",
    "legoboost.color.any": "beliebige Farbe"
  },
  "fr": {
    "legoboost.motorOnFor": "allumer le moteur [MOTOR_ID] pendant [DURATION] secondes",
    "legoboost.motorOnForRotation": "tourner le moteur [MOTOR_ID] pendant [ROTATION] rotations",
    "legoboost.motorRunToPosition": "tourner le moteur [MOTOR_ID] à la position [POSITION]",
    "legoboost.motorOn": "allumer le moteur [MOTOR_ID]",
    "legoboost.motorOff": "éteindre le moteur [MOTOR_ID]",
    "legoboost.setMotorPower": "régler la vitesse du moteur [MOTOR_ID] à [POWER] %",
    "legoboost.setMotorDirection": "régler la direction du moteur [MOTOR_ID] [MOTOR_DIRECTION]",
    "legoboost.setMotorStopAction": "régler l'action d'arrêt du moteur [MOTOR_ID] sur [ACTION]",
    "legoboost.setMotorAcceleration": "régler l'accélération du moteur [MOTOR_ID] à [TIME] ms",
    "legoboost.setMotorDeceleration": "régler la décélération du moteur [MOTOR_ID] à [TIME] ms",
    "legoboost.resetMotorPosition": "remettre la position du moteur [MOTOR_ID] à [POSITION]",
    "legoboost.getMotorPosition": "position du moteur [MOTOR_REPORTER_ID]",
    "legoboost.whenColor": "quand [PORT] voit une brique [COLOR]",
    "legoboost.seeingColor": "[PORT] voit une brique [COLOR] ?",
    "legoboost.getDistance": "[PORT] distance (mm)",
    "legoboost.getReflection": "[PORT] réflexion (%)",
    "legoboost.getForce": "[PORT] force (N)",
    "legoboost.isForceSensorPressed": "[PORT] capteur de force appuyé ?",
    "legoboost.whenForceSensorPressed": "quand [PORT] capteur de force appuyé",
    "legoboost.whenTilted": "quand incliné [TILT_DIRECTION_ANY]",
    "legoboost.isTilted": "incliné [TILT_DIRECTION_ANY] ?",
    "legoboost.getTiltAngle": "angle d'inclinaison [TILT_DIRECTION]",
    "legoboost.setLightHue": "régler la couleur de la lumière sur [HUE]",
    "legoboost.shutdown": "éteindre le hub",
    "legoboost.whenButtonPressed": "quand le bouton du hub est appuyé",
    "legoboost.isButtonPressed": "bouton du hub appuyé ?",
    "legoboost.getBatteryLevel": "niveau de batterie (%)",
    "legoboost.getFirmwareVersion": "version du firmware",
    "legoboost.getRSSI": "force du signal Bluetooth",
    "legoboost.whenBatteryLow": "quand la batterie est faible",
    "legoboost.whenMotorOverloaded": "quand le moteur est surchargé",
    "legoboost.stopAction.float": "flotter",
    "legoboost.stopAction.brake": "freiner",
    "legoboost.stopAction.hold": "maintenir",
    "legoboost.motorDirection.forward": "dans ce sens",
    "legoboost.motorDirection.backward": "dans l'autre sens",
    "legoboost.motorDirection.reverse": "inverser",
    "legoboost.tiltDirection.up": "vers le haut",
    "legoboost.tiltDirection.down": "vers le bas",
    "legoboost.tiltDirection.left": "vers la gauche",
    "legoboost.tiltDirection.right": "vers la droite",
    "legoboost.tiltDirection.any": "n'importe comment",
    "legoboost.color.red": "rouge",
    "legoboost.color.blue": "bleu",
    "legoboost.color.green": "vert",
    "legoboost.color.yellow": "jaune",
    "legoboost.color.white": "blanc",
    "legoboost.color.black": "noir",
    "legoboost.color.any": "n'importe quelle couleur"
  }
}; // Import VM translations
...
var formatMessageFunction = function formatMessageFunction(messageData) {
  return messageData.defaultMessage;
};
...
var setupTranslations = function setupTranslations() {
  try {
    var localeSetup = formatMessageFunction.setup();
 ...
 */
var BoostMotorMaxPowerAdd = 10; // Additional power for reaching target speed faster
var BoostPingInterval = 5000; // Battery check interval
var BoostColorSampleSize = 5; // Number of samples for stable color detection
...
var BoostIO = {
  MOTOR_WEDO: 0x01,
  // Legacy reference (not used in practice)
  MOTOR_SYSTEM: 0x02,
  // System train motor
  BUTTON: 0x05,
  // Hub button
...
var BoostColorIndex = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, BoostColor.NONE, 255), BoostColor.RED, 9), BoostColor.BLUE, 3), BoostColor.GREEN, 5), BoostColor.YELLOW, 7), BoostColor.WHITE, 10), BoostColor.BLACK, 0);
...
var BoostMode = {
  ...
  REFLECTION: 3,
  // Reflection/ambient light mode
  AMBIENT: 4,
  // Ambient light mode
  MOTOR_SENSOR: 2,
  // Motor position/rotation mode
  FORCE: 0,
...
var numberToInt32Array = function numberToInt32Array(number) {
  ...
  return [dataview.getInt8(0), dataview.getInt8(1), dataview.getInt8(2), dataview.getInt8(3)];
};
 ...
 */
var decodeVersion = function decodeVersion(version) {
  var buffer = new ArrayBuffer(4);
  var view = new DataView(buffer);
  view.setInt32(0, version, true);
  var major = view.getUint8(3) >> 4;
  var minor = view.getUint8(3) & 0x0F;
  var bugfix = view.getUint8(2);
  var build = view.getUint16(0, true);
  return "".concat(major, ".").concat(minor, ".").concat(bugfix.toString().padStart(2, '0'), ".").concat(build.toString().padStart(4, '0'));
};
...
var BoostMotor = /*#__PURE__*/function () {
  ...
  _createClass(BoostMotor, [{
    ...
    key: "setAcceleration",
    value: function setAcceleration(time) {
      this._accelerationTime = MathUtil.clamp(time, 0, 10000);
      this._useProfile |= BoostMotorProfile.ACCELERATION;
      var cmd = this._parent.generateOutputCommand(this._index, BoostOutputExecution.EXECUTE_IMMEDIATELY, BoostOutputSubCommand.SET_ACC_TIME, [].concat(_toConsumableArray(numberToInt32Array(this._accelerationTime).slice(0, 2)), [0]));
    ...
    key: "setDeceleration",
    value: function setDeceleration(time) {
      this._decelerationTime = MathUtil.clamp(time, 0, 10000);
      this._useProfile |= BoostMotorProfile.DECELERATION;
      var cmd = this._parent.generateOutputCommand(this._index, BoostOutputExecution.EXECUTE_IMMEDIATELY, BoostOutputSubCommand.SET_DEC_TIME, [].concat(_toConsumableArray(numberToInt32Array(this._decelerationTime).slice(0, 2)), [0]));
      this._parent.send(BoostBLE.characteristic, cmd);
    }
    ...
    value: function resetPosition() {
      var newPosition = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
      var cmd = this._parent.generateOutputCommand(this._index, BoostOutputExecution.EXECUTE_IMMEDIATELY, BoostOutputSubCommand.WRITE_DIRECT_MODE_DATA, [BoostMode.MOTOR_SENSOR].concat(_toConsumableArray(numberToInt32Array(newPosition))));
    ...
    value: function _turnOn() {
      var cmd = this._parent.generateOutputCommand(this._index, BoostOutputExecution.EXECUTE_IMMEDIATELY, BoostOutputSubCommand.START_SPEED, [this.power * this.direction, MathUtil.clamp(this.power + BoostMotorMaxPowerAdd, 0, 100), this._useProfile]);
      this._parent.send(BoostBLE.characteristic, cmd);
    }
    ...
    key: "turnToPosition",
    value: function turnToPosition(position) {
      var cmd = this._parent.generateOutputCommand(this._index, BoostOutputExecution.EXECUTE_IMMEDIATELY | BoostOutputExecution.COMMAND_FEEDBACK, BoostOutputSubCommand.GO_TO_ABS_POSITION, [].concat(_toConsumableArray(numberToInt32Array(position)), [this.power, MathUtil.clamp(this.power + BoostMotorMaxPowerAdd, 0, 100), this._stopMode, this._useProfile]));
      this.status = BoostMotorState.ON_FOR_ROTATION;
    ...
    value: function turnOff() {
      ...
      var cmd = this._parent.generateOutputCommand(this._index, BoostOutputExecution.EXECUTE_IMMEDIATELY, BoostOutputSubCommand.START_POWER, [this._stopMode === BoostMotorEndState.FLOAT ? BoostMotorEndState.FLOAT : 0]);
...
var Boost = /*#__PURE__*/function () {
  ...
  _createClass(Boost, [{
    ...
    get: function get() {
      ...
      return this._sensors.color[BoostPort.C] || Object.values(this._sensors.color)[0] || BoostColor.NONE;
    }
  }, {
    key: "previousColor",
    get: function get() {
    ...
    value: function shutdown() {
      ...
      var cmd = [0, BoostMessage.HUB_ACTIONS, BoostHubAction.SWITCH_OFF_HUB];
    ...
    value: function setLED(inputRGB) {
      ...
      var ledPortIndex = this._ports.indexOf(BoostIO.LED);
      if (ledPortIndex === -1) return Promise.resolve();
      var cmd = this.generateOutputCommand(ledPortIndex, BoostOutputExecution.EXECUTE_IMMEDIATELY | BoostOutputExecution.COMMAND_FEEDBACK, BoostOutputSubCommand.WRITE_DIRECT_MODE_DATA, [BoostMode.LED].concat(rgb));
    ...
    value: function setLEDMode() {
      var ledPortIndex = this._ports.indexOf(BoostIO.LED);
      if (ledPortIndex === -1) return Promise.resolve();
      var cmd = this.generateInputCommand(ledPortIndex, BoostMode.LED, 0, false);
      return this.send(BoostBLE.characteristic, cmd);
    }
    ...
    value: function generateInputCommand(portID, mode, delta, enableNotifications) {
      var command = [0x00, BoostMessage.PORT_INPUT_FORMAT_SETUP_SINGLE, portID, mode].concat(numberToInt32Array(delta)).concat([enableNotifications ? 1 : 0]);
      command.unshift(command.length + 1);
      return command;
    }
    ...
    key: "_setInputMode",
    value: (function () {
      var _setInputMode2 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(port, mode) {
        var cmd;
        return regenerator.wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              if (!(this._portModes[port] === mode)) {
                _context.next = 2;
                break;
              }
            ...
            case 2:
              ...
              cmd = this.generateInputCommand(port, mode, 1, true);
              _context.next = 6;
              return this.send(BoostBLE.characteristic, cmd);
            case 6:
      ...
      function _setInputMode(_x, _x2) {
        return _setInputMode2.apply(this, arguments);
      }
      return _setInputMode;
    }()
    /**
    ...
    value: function _onConnect() {
      ...
      setTimeout(function () {
        var command = [0x00, BoostMessage.HUB_PROPERTIES, BoostHubProperty.FW_VERSION, BoostHubPropertyOperation.REQUEST_UPDATE];
        command.unshift(command.length + 1);
        _this2.send(BoostBLE.characteristic, command, false);
      }, 500);

      // Enable comprehensive hub status monitoring
      var statusCommands = [[BoostMessage.HUB_PROPERTIES, BoostHubProperty.HW_VERSION, BoostHubPropertyOperation.REQUEST_UPDATE], [BoostMessage.HUB_PROPERTIES, BoostHubProperty.BATTERY_VOLTAGE, BoostHubPropertyOperation.ENABLE_UPDATES], [BoostMessage.HUB_PROPERTIES, BoostHubProperty.BUTTON, BoostHubPropertyOperation.ENABLE_UPDATES], [BoostMessage.HUB_PROPERTIES, BoostHubProperty.RSSI, BoostHubPropertyOperation.ENABLE_UPDATES], [BoostMessage.HUB_ALERTS, BoostAlert.LOW_VOLTAGE, BoostAlertOperation.ENABLE_UPDATES], [BoostMessage.HUB_ALERTS, BoostAlert.HIGH_CURRENT, BoostAlertOperation.ENABLE_UPDATES], [BoostMessage.HUB_ALERTS, BoostAlert.OVER_POWER_CONDITION, BoostAlertOperation.ENABLE_UPDATES]];
      statusCommands.forEach(function (cmdData) {
        var cmd = [0].concat(_toConsumableArray(cmdData));
        cmd.unshift(cmd.length + 1);
        _this2.send(BoostBLE.characteristic, cmd, false);
      });
    }
    ...
    value: function _onMessage(base64) {
      ...
      switch (messageType) {
        case BoostMessage.HUB_PROPERTIES:
          {
            ...
            switch (property) {
              case BoostHubProperty.FW_VERSION:
                {
                  ...
                  var fwHub = int32ArrayToNumber(data.slice(5, 9));
              ...
              case BoostHubProperty.HW_VERSION:
                {
                  var hwVersion = int32ArrayToNumber(data.slice(5, 9));
        ...
        case BoostMessage.HUB_ALERTS:
          {
            var alertType = data[3];
            var _operation = data[4];
            if (_operation !== BoostAlertOperation.UPDATE) break;
            var status = data[5] === 0xFF;
            switch (alertType) {
        ...
        case BoostMessage.PORT_VALUE:
          {
            ...
            var mode = this._portModes[portID];
            switch (type) {
              case BoostIO.TILT:
        ...
        case BoostMessage.ERROR:
          log.warn("Error reported by hub: ".concat(Array.from(data)));
          break;
      }
    }
...
var Scratch3BoostBlocks = /*#__PURE__*/function () {
  ...
  _createClass(Scratch3BoostBlocks, [{
    ...
    value: function getInfo() {
      ...
      return {
        ...
        name: formatMessageFunction({
          id: 'gui.extension.legoboost.name',
          // Note: This will fallback as it's in GUI translations
    ...
    key: "_getPortFromLabel",
    value: function _getPortFromLabel(label) {
      switch (label) {
        case 'A':
          return BoostPort.A;
        case 'B':
        ...
        if (motor) {
          switch (args.MOTOR_DIRECTION) {
            ...
            case BoostMotorDirection.REVERSE:
              ...
              break;
            default:
              log.warn("Unknown motor direction in setMotorDirection: ".concat(args.MOTOR_DIRECTION));
              break;
          }
    ...
    key: "setMotorStopAction",
    value: function setMotorStopAction(args) {
      var _this10 = this;
      var stopModeMap = {
      ...
      var action = stopModeMap[args.ACTION] || BoostMotorEndState.BRAKE;
      this._forEachMotor(args.MOTOR_ID, function (motorIndex) {
        var motor = _this10._peripheral.motor(motorIndex);
        if (motor) {
    ...
    key: "setMotorAcceleration",
    value: function setMotorAcceleration(args) {
      var _this11 = this;
      var time = Cast.toNumber(args.TIME);
      this._forEachMotor(args.MOTOR_ID, function (motorIndex) {
        var motor = _this11._peripheral.motor(motorIndex);
        if (motor) {
    ...
    key: "setMotorDeceleration",
    value: function setMotorDeceleration(args) {
      var _this12 = this;
      var time = Cast.toNumber(args.TIME);
      this._forEachMotor(args.MOTOR_ID, function (motorIndex) {
        var motor = _this12._peripheral.motor(motorIndex);
        if (motor) {
    ...
    value: function resetMotorPosition(args) {
      ...
      var position = Cast.toNumber(args.POSITION);
      this._forEachMotor(args.MOTOR_ID, function (motorIndex) {
        var motor = _this13._peripheral.motor(motorIndex);
        if (motor) {
    ...
    key: "_checkColor",
    value: function () {
      var _checkColor2 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(args) {
        var port, currentColor;
        return regenerator.wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              port = this._getPortFromLabel(args.PORT);
              if (!(port === null)) {
                _context2.next = 3;
                break;
              }
            ...
            case 3:
              _context2.next = 5;
              return this._peripheral._setInputMode(port, BoostMode.COLOR);
            case 5:
              currentColor = this._peripheral.getColor(port);
              if (!(args.COLOR === BoostColor.ANY)) {
                _context2.next = 8;
                break;
              }
              return _context2.abrupt("return", currentColor !== BoostColor.NONE);
            case 8:
              return _context2.abrupt("return", currentColor === args.COLOR);
            case 9:
            case "end":
      ...
      function _checkColor(_x3) {
        return _checkColor2.apply(this, arguments);
      }
      return _checkColor;
    }()
    /**
    ...
    key: "getDistance",
    value: (function () {
      var _getDistance = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(args) {
        var port;
        return regenerator.wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 3:
              _context3.next = 5;
              return this._peripheral._setInputMode(port, BoostMode.DISTANCE);
            case 5:
              return _context3.abrupt("return", this._peripheral.getDistance(port));
            case 6:
            case "end":
    ...
    key: "getReflection",
    value: (function () {
      var _getReflection = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee4(args) {
        var port;
        return regenerator.wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 3:
              _context4.next = 5;
              return this._peripheral._setInputMode(port, BoostMode.REFLECTION);
            case 5:
              return _context4.abrupt("return", this._peripheral.getReflection(port));
            case 6:
            case "end":
      ...
      function getReflection(_x5) {
        return _getReflection.apply(this, arguments);
      }
    ...
    key: "getForce",
    value: (function () {
      var _getForce = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee5(args) {
        var port;
        return regenerator.wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 3:
              _context5.next = 5;
              return this._peripheral._setInputMode(port, BoostMode.FORCE);
            case 5:
              return _context5.abrupt("return", this._peripheral.getForce(port));
            case 6:
            case "end":
      ...
      function getForce(_x6) {
        return _getForce.apply(this, arguments);
      }
      return getForce;
    }()
    /**
    ...
    value: (function () {
      var _isForceSensorPressed = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee6(args) {
        var port;
        return regenerator.wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            ...
            case 3:
              _context6.next = 5;
              return this._peripheral._setInputMode(port, BoostMode.TOUCHED);
            case 5:
              return _context6.abrupt("return", this._peripheral.isForcePressed(port));
            case 6:
            case "end":
      ...
      function isForceSensorPressed(_x7) {
        return _isForceSensorPressed.apply(this, arguments);
      }
      return isForceSensorPressed;
    }()
    /**
    ...
    value: function whenButtonPressed() {
    ...
    key: "whenMotorOverloaded",
    value: function whenMotorOverloaded() {
