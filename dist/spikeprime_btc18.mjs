...
// Enhanced color definitions with visual emoji representations
var Matrix3x3ColorItems = [{
  text: '⚫ Off',
  value: 'off'
}, {
  text: '🟣 Magenta',
...
// Color shorthand mappings for the pattern designer
...
// Quick pattern cells with visual color representation
var PatternCells = [{
  text: '⚫⚫⚫',
  value: '.1 .1 .1'
},
...
// Quick color+brightness combinations with visual representation
var ColorBrightnessQuick = [{
  text: '⚫ Off',
  value: '.1'
}, {
  text: '🔴▫ Red Low',
...
// Pattern presets with visual names
var Pattern3x3Presets = [{
  text: '❤️ Heart',
  value: 'r9 .1 r9|r6 r10 r6|.1 r8 .1'
}, {
  text: '😊 Smile',
  value: 'y6 .1 y6|.1 y8 .1|y6 .1 y6'
}, {
  text: '⭐ Star',
  value: '.1 y8 .1|y6 y10 y6|.1 y8 .1'
}, {
  text: '⬆️ Arrow Up',
  value: '.1 g8 .1|g6 g8 g6|.1 g6 .1'
}, {
  text: '⬇️ Arrow Down',
  value: '.1 b6 .1|b6 b8 b6|.1 b8 .1'
}, {
  text: '⬅️ Arrow Left',
  value: '.1 o6 .1|o8 o6 .1|.1 o6 .1'
}, {
  text: '➡️ Arrow Right',
  value: '.1 o6 .1|.1 o6 o8|.1 o6 .1'
}, {
  text: '❌ X Mark',
  value: 'r7 .1 r7|.1 r9 .1|r7 .1 r7'
}, {
  text: '✅ Check',
  value: '.1 .1 g8|.1 g8 g6|g8 .1 .1'
}, {
  text: '🔵 Dot',
  value: '.1 .1 .1|.1 b10 .1|.1 .1 .1'
}, {
  text: '🔲 Frame',
  value: 'b6 b6 b6|b6 .1 b6|b6 b6 b6'
}, {
  text: '🌈 Rainbow',
  value: 'r8 y8 g8|o6 w9 b6|m5 v5 t5'
}];
  ...
  _createClass(Scratch3SpikePrimeBlocks, [{
    ...
    value: function getInfo() {
      ...
      return {
         ...
         */
        {
          opcode: 'setMatrix3x3PatternDesigner',
          text: '🎨 [PORT] pattern: 🔸[ROW1]🔸 🔸[ROW2]🔸 🔸[ROW3]🔸',
          blockType: BlockType.COMMAND,
          arguments: {
            PORT: {
              type: ArgumentType.STRING,
          ...
          opcode: 'setMatrix3x3ClickDesigner',
          text: '🖱️ [PORT] click design: 🔴[C1]🔴[C2]🔴[C3]🔴 🔴[C4]🔴[C5]🔴[C6]🔴 🔴[C7]🔴[C8]🔴[C9]🔴',
          blockType: BlockType.COMMAND,
          arguments: {
            PORT: {
              type: ArgumentType.STRING,
          ...
          opcode: 'setMatrix3x3GridDesigner',
          text: '📱 [PORT] grid: ┌[P1][P2][P3]┐ │[P4][P5][P6]│ └[P7][P8][P9]┘',
          blockType: BlockType.COMMAND,
          arguments: {
            PORT: {
              type: ArgumentType.STRING,
          ...
          text: '📋 [PORT] matrix preset [PRESET]',
          blockType: BlockType.COMMAND,
          arguments: {
            PORT: {
              type: ArgumentType.STRING,
            ...
            PRESET: {
              type: ArgumentType.STRING,
              menu: 'PATTERN_3X3_PRESET',
              defaultValue: 'r9 .1 r9|r6 r10 r6|.1 r8 .1'
            }
          }
        }, '---', {
          opcode: 'setMatrix3x3SingleColor',
          text: '🌈 [PORT] matrix all [COLOR] brightness [BRIGHTNESS]',
          blockType: BlockType.COMMAND,
          arguments: {
            PORT: {
              type: ArgumentType.STRING,
            ...
            COLOR: {
              type: ArgumentType.STRING,
              menu: 'MATRIX_3X3_COLOR_VISUAL',
              defaultValue: 'red'
            },
            BRIGHTNESS: {
              type: ArgumentType.STRING,
              menu: 'BRIGHTNESS_VISUAL',
              defaultValue: '5'
            }
          }
        }, {
          opcode: 'setMatrix3x3Pixel',
          text: '📍 [PORT] pixel ([X], [Y]) = [COLOR] brightness [BRIGHTNESS]',
          blockType: BlockType.COMMAND,
          arguments: {
            PORT: {
              type: ArgumentType.STRING,
          ...
          opcode: 'setMatrix3x3Animation',
          text: '✨ [PORT] matrix animate [EFFECT] with [COLOR]',
          blockType: BlockType.COMMAND,
          arguments: {
            PORT: {
              type: ArgumentType.STRING,
          ...
          opcode: 'setMatrix3x3Rainbow',
          text: '🌈 [PORT] rainbow pattern brightness [BRIGHTNESS]',
          blockType: BlockType.COMMAND,
          arguments: {
            PORT: {
              type: ArgumentType.STRING,
          ...
          opcode: 'setMatrix3x3Help',
          text: '❓ 3x3 help: [HELP_TYPE]',
          blockType: BlockType.REPORTER,
          arguments: {
            HELP_TYPE: {
              type: ArgumentType.STRING,
              menu: 'MATRIX_HELP_TYPE',
              defaultValue: 'how_to_use'
            }
          }
        }, '---',
        // ===== ENHANCED GESTURES =====
        ...
        menus: {
          ...
          // ===== ENHANCED 3x3 MATRIX MENUS =====
          COLOR_BRIGHTNESS_QUICK: {
            acceptReporters: false,
            items: ColorBrightnessQuick
          },
          COLOR_BRIGHTNESS_VISUAL: {
            acceptReporters: false,
            items: [{
              text: '⚫ Off',
              value: '.1'
          ...
          MATRIX_3X3_COLOR_VISUAL: {
            acceptReporters: false,
            items: Matrix3x3ColorItems
          },
          MATRIX_HELP_TYPE: {
            acceptReporters: false,
            items: [{
    ...
    key: "setMatrix3x3PatternDesigner",
    value: function setMatrix3x3PatternDesigner(args) {
      var port = Cast.toString(args.PORT).trim().toUpperCase();
      var row1 = Cast.toString(args.ROW1);
      var row2 = Cast.toString(args.ROW2);
      var row3 = Cast.toString(args.ROW3);
      var pattern = "".concat(row1, "|").concat(row2, "|").concat(row3);
      return this._setMatrix3x3FromPattern(port, pattern);
    }
  }, {
    key: "setMatrix3x3ClickDesigner",
    value: function setMatrix3x3ClickDesigner(args) {
      var port = Cast.toString(args.PORT).trim().toUpperCase();

      // Map emoji colors to our color codes with default brightness
      var emojiToCode = {
        '⚫': '.1',
        // Off
        '🔴': 'r8',
        ...
        '⚪': 'w8',
        // White
        '🌈': 'r8' // Rainbow default to red
      };

      // Collect all 9 pixel values from C1-C9
      var pixels = [];
      for (var i = 1; i <= 9; i++) {
        var emoji = Cast.toString(args["C".concat(i)]);
        pixels.push(emojiToCode[emoji] || '.1');
      }

      // Convert to 3x3 pattern (3 pixels per row)
      var pattern = [pixels.slice(0, 3).join(' '),
      // Row 1: C1, C2, C3
      pixels.slice(3, 6).join(' '),
      // Row 2: C4, C5, C6  
      pixels.slice(6, 9).join(' ') // Row 3: C7, C8, C9
      ].join('|');
      return this._setMatrix3x3FromPattern(port, pattern);
    }
  }, {
    key: "setMatrix3x3GridDesigner",
    value: function setMatrix3x3GridDesigner(args) {
      var port = Cast.toString(args.PORT).trim().toUpperCase();

      // Collect all 9 pixel values from P1-P9
      var pixels = [];
      for (var i = 1; i <= 9; i++) {
        pixels.push(Cast.toString(args["P".concat(i)]) || '.1');
      }
      ...
      pixels.slice(3, 6).join(' '),
      // Row 2: P4, P5, P6
      pixels.slice(6, 9).join(' ') // Row 3: P7, P8, P9
      ].join('|');
      return this._setMatrix3x3FromPattern(port, pattern);
    }
    ...
    key: "setMatrix3x3SingleColor",
    value: function setMatrix3x3SingleColor(args) {
      var port = Cast.toString(args.PORT).trim().toUpperCase();
      var colorName = Cast.toString(args.COLOR);
      var brightness = Cast.toNumber(args.BRIGHTNESS);
      ...
      var colorId = colorMap[colorName] || 0;
      var clampedBrightness = MathUtil.clamp(brightness, 1, 10);
      if (colorId === 0) {
        // Use clear mode for off
        return this.clearMatrix3x3(args);
      }

      // Create pattern with all pixels the same color
      var pixelValue = clampedBrightness * 16 + colorId;
      var byteString = Array(9).fill("\\x".concat(pixelValue.toString(16).padStart(2, '0'))).join('');
      return this._peripheral.sendPythonCommand("import hub; matrix = hub.port.".concat(port, ".device; matrix.mode(2); matrix.mode(2, b\"").concat(byteString, "\")"));
    }
  }, {
    ...
    key: "setMatrix3x3Animation",
    value: function setMatrix3x3Animation(args) {
      var port = Cast.toString(args.PORT).trim().toUpperCase();
      var effect = Cast.toString(args.EFFECT);
      var colorName = Cast.toString(args.COLOR);
      var colorMap = {
      ...
      var colorId = colorMap[colorName] || 6; // Default to green

      // Animation patterns
      var animations = {
        pulse: "\nimport hub, time\nmatrix = hub.port.".concat(port, ".device\nmatrix.mode(2)\nfor brightness in [3, 6, 10, 6, 3, 1]:\n    pixel_val = brightness * 16 + ").concat(colorId, "\n    pattern = bytes([pixel_val] * 9)\n    matrix.mode(2, pattern)\n    time.sleep_ms(200)\n"),
        wave: "\nimport hub, time\nmatrix = hub.port.".concat(port, ".device\nmatrix.mode(2)\npatterns = [\n    [").concat(colorId * 16 + 8, ", 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01],\n    [0x01, ").concat(colorId * 16 + 8, ", 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01],\n    [0x01, 0x01, ").concat(colorId * 16 + 8, ", 0x01, 0x01, 0x01, 0x01, 0x01, 0x01],\n    [0x01, 0x01, 0x01, ").concat(colorId * 16 + 8, ", 0x01, 0x01, 0x01, 0x01, 0x01],\n    [0x01, 0x01, 0x01, 0x01, ").concat(colorId * 16 + 10, ", 0x01, 0x01, 0x01, 0x01],\n    [0x01, 0x01, 0x01, 0x01, 0x01, ").concat(colorId * 16 + 8, ", 0x01, 0x01, 0x01],\n    [0x01, 0x01, 0x01, 0x01, 0x01, 0x01, ").concat(colorId * 16 + 8, ", 0x01, 0x01],\n    [0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, ").concat(colorId * 16 + 8, ", 0x01],\n    [0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, ").concat(colorId * 16 + 8, "]\n]\nfor pattern in patterns:\n    matrix.mode(2, bytes(pattern))\n    time.sleep_ms(150)\n"),
        heartbeat: "\nimport hub, time\nmatrix = hub.port.".concat(port, ".device\nmatrix.mode(2)\nheart = bytes([").concat(colorId * 16 + 9, ", 0x01, ").concat(colorId * 16 + 9, ", ").concat(colorId * 16 + 6, ", ").concat(colorId * 16 + 10, ", ").concat(colorId * 16 + 6, ", 0x01, ").concat(colorId * 16 + 8, ", 0x01])\noff = bytes([0x01] * 9)\nfor _ in range(3):\n    matrix.mode(2, heart)\n    time.sleep_ms(200)\n    matrix.mode(2, off)\n    time.sleep_ms(100)\n    matrix.mode(2, heart)\n    time.sleep_ms(200)\n    matrix.mode(2, off)\n    time.sleep_ms(400)\n")
      };
      return this._peripheral.sendPythonCommand(animations[effect] || animations.pulse);
    }
  }, {
    key: "setMatrix3x3Rainbow",
    value: function setMatrix3x3Rainbow(args) {
      var port = Cast.toString(args.PORT).trim().toUpperCase();
      var brightness = MathUtil.clamp(Cast.toNumber(args.BRIGHTNESS), 1, 10);

      // Rainbow pattern: red, orange, yellow, green, mint, turquoise, blue, violet, magenta
      var rainbowColors = [9, 8, 7, 6, 5, 4, 3, 2, 1]; // Color IDs
      var pattern = rainbowColors.map(function (colorId) {
        return brightness * 16 + colorId;
      });
      var byteString = pattern.map(function (val) {
        return "\\x".concat(val.toString(16).padStart(2, '0'));
      }).join('');
      return this._peripheral.sendPythonCommand("import hub; matrix = hub.port.".concat(port, ".device; matrix.mode(2); matrix.mode(2, b\"").concat(byteString, "\")"));
    }
    ...
    key: "setMatrix3x3Help",
    value: function setMatrix3x3Help(args) {
      var helpType = Cast.toString(args.HELP_TYPE);
      switch (helpType) {
        case 'how_to_use':
          return 'Choose pattern designer: 🎨 for rows, 🖱️ for emoji colors, 📱 for grid layout. Each offers different ways to design your 3x3 matrix!';
        case 'color_codes':
          return 'Colors: r=🔴Red, g=🟢Green, b=🔵Blue, y=🟡Yellow, o=🟠Orange, w=⚪White, m=🟣Magenta, t=🔷Turquoise, v=🟣Violet, .=⚫Off';
        case 'brightness':
          return 'Brightness: 1=▪Dim, 2-3=◾Low, 4-6=⬛Mid, 7-8=🔥High, 9-10=💎Max. Add number after color: r8=🔴🔥';
        case 'examples':
          return 'Heart: r9 .1 r9 | r6 r10 r6 | .1 r8 .1 --- Smile: y6 .1 y6 | .1 y8 .1 | y6 .1 y6';
        case 'technical':
          return 'Format: ColorBrightness (r8, g5, .1). Rows separated by |. Each pixel: brightness×16+colorID. Total 9 pixels in 3×3 grid.';
        default:
          return 'Use the visual designers to create amazing 3x3 LED patterns!';
      }
    }
  }, {
    key: "_setMatrix3x3FromPattern",
    value: function _setMatrix3x3FromPattern(port, pattern) {
      try {
        var _this$_parseMatrix3x = this._parseMatrix3x3Pattern(pattern),
          byteString = _this$_parseMatrix3x.byteString;
        return this._peripheral.sendPythonCommand("import hub; matrix = hub.port.".concat(port, ".device; matrix.mode(2); matrix.mode(2, b\"").concat(byteString, "\")"));
      } catch (error) {
        console.warn('Error parsing 3x3 pattern:', error);
        return this.clearMatrix3x3({
    ...
    key: "_parseMatrix3x3Pattern",
    value: function _parseMatrix3x3Pattern(pattern) {
      var colorCodes = {
        '.': 0,
        'm': 1,
        'v': 2,
      ...
      try {
        for (_iterator7.s(); !(_step7 = _iterator7.n()).done;) {
          ...
          var pixelCodes = line.trim().split(/\s+/);
          var _iterator8 = _createForOfIteratorHelper(pixelCodes),
            _step8;
          try {
