      ...
      var _connect = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
        ...
        return regenerator.wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 4:
              _context.prev = 4;
              console.log('🔍 Requesting DualShock 4 device...');
              _context.next = 8;
            ...
            case 12:
              ...
              console.log("\uD83C\uDFAE Selected device: ".concat(this.device.productName, " (").concat(this.device.vendorId.toString(16), ":").concat(this.device.productId.toString(16), ")"));
              _context.next = 16;
  ...
  _createClass(Scratch3DualShock4Blocks, [{
    ...
    value: function getInfo() {
      return {
        ...
        // No status button needed for WebHID
        blocks: [{
          opcode: 'connect',
