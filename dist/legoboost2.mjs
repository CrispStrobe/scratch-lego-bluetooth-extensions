    ...
    value: function getInfo() {
      return {
        ...
        // Force sensor
        {
          ...
          text: formatMessage({
            id: 'boost.whenForceSensorPressed',
