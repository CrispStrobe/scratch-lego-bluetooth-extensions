...
var Scratch3PMBlocks = /*#__PURE__*/function () {
  ...
  _createClass(Scratch3PMBlocks, [{
    ...
    key: "add",
    value: function add(args, util) {
      return Cast.toNumber(args.NUM1) + Cast.toNumber(args.NUM2);
    }
  }, {
    key: "substract",
    value: function substract(args, util) {
      return Cast.toNumber(args.NUM1) - Cast.toNumber(args.NUM2);
    }
  }, {
    key: "multiply",
    value: function multiply(args, util) {
      return Cast.toNumber(args.NUM1) * Cast.toNumber(args.NUM2);
    }
  }, {
    key: "divide",
    value: function divide(args, util) {
      return Cast.toNumber(args.NUM1) / Cast.toNumber(args.NUM2);
    }
  }, {
    key: "pow",
    value: function pow(args, util) {
    ...
    key: "pourcent",
    value: function pourcent(args, util) {
      return Cast.toNumber(args.NUM1) / 100;
    }
  }, {
    key: "mathop",
    value: function mathop(args, util) {
    ...
    key: "mathop2",
    value: function mathop2(args, util) {
      var operator = Cast.toString(args.OPERATOR).toLowerCase();
    ...
    key: "mathopdiv",
    value: function mathopdiv(args, util) {
      var operator = Cast.toString(args.OPERATOR).toLowerCase();
      var n1 = Cast.toNumber(args.NUM1);
      var n2 = Cast.toNumber(args.NUM2);
      if (Number.isInteger(n1) && Number.isInteger(n2)) {
    ...
    key: "arrondis",
    value: function arrondis(args, util) {
    ...
    key: "sqrt",
    value: function sqrt(args, util) {
      return Math.sqrt(Cast.toNumber(args.NUM1));
    }
  }, {
    key: "chiffre_pentiere",
    value: function chiffre_pentiere(args, util) {
    ...
    value: function chiffre_pdecimale(args, util) {
      return Math.floor(Cast.toNumber(args.NUM1) * Math.pow(10, Cast.toNumber(args.choix1))) - Math.floor(Cast.toNumber(args.NUM1) * Math.pow(10, Cast.toNumber(args.choix1) - 1)) * 10;
    }
  }, {
    key: "multiple",
    ...
    key: "nombre_pi",
    value: function nombre_pi(args, util) {
      return Math.PI;
    }
  }, {
    key: "join",
    ...
    value: function reverseString(str) {
      if (str === "") return "";else return this.reverseString(str.substr(1)) + str.charAt(0);
    }
  }, {
    key: "extract",
