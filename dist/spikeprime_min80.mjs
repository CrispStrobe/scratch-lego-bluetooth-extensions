...
var Scratch3SpikePrimeBlocks = /*#__PURE__*/function (_BleBaseBlocks) {
  ...
  function Scratch3SpikePrimeBlocks(runtime) {
    ...
    // SPIKE Prime hub type - trying 0x81 first, fallback to 0x80 if needed
  ...
  _createClass(Scratch3SpikePrimeBlocks, [{
    ...
    // Override hub tilt to match SPIKE Prime scale
  }, {
    key: "getHubTilt",
    value: function getHubTilt(args) {
      var value = _get(_getPrototypeOf(Scratch3SpikePrimeBlocks.prototype), "getHubTilt", this).call(this, args);
      return value != null ? value / 10 : 0;
    }

    // Add SPIKE Prime specific sensor blocks if needed
  }, {
    key: "getBlocks",
    value: function getBlocks(formatMessage) {
      var baseBlocks = _get(_getPrototypeOf(Scratch3SpikePrimeBlocks.prototype), "getBlocks", this).call(this, formatMessage);

      // Add any SPIKE Prime specific blocks here if needed
      // For now, use the base blocks which should cover most functionality
      return baseBlocks;
    }
  }, {
    key: "getMenus",
    value: function getMenus(formatMessage) {
      var baseMenus = _get(_getPrototypeOf(Scratch3SpikePrimeBlocks.prototype), "getMenus", this).call(this, formatMessage);

      // Override port menus to show all 6 ports
      baseMenus.PORT = {
        acceptReporters: true,
        items: this.externalPorts
      };
      baseMenus.MULTIPLE_PORT = {
        acceptReporters: true,
        items: this.multipleExternalPorts
      };
      return baseMenus;
