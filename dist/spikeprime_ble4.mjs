...
// SPIKE Prime specific BLE UUIDs (from working boilerplate)
...
var SpikePrime = /*#__PURE__*/function () {
  ...
  _createClass(SpikePrime, [{
    ...
    value: function scan() {
      ...
      try {
        // SPIKE Prime uses a different BLE setup - scan for the specific service
        this._ble = new BLE(this._runtime, this._extensionId, {
          ...
          // SPIKE Prime often shows as "LEGO Hub"
          {
