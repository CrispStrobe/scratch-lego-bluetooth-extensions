...
var Scratch3PMBlocks = /*#__PURE__*/function () {
  function Scratch3PMBlocks(runtime) {
    ...
    // The robust way to set up translations.
    // This gets the locale directly from the Scratch editor.
    var locale = this.runtime.getLocale();
    console.log("%cPlaneteMaths Extension: Forcing locale from runtime: \"".concat(locale, "\""), 'color: green; font-weight: bold;');
    formatMessage.setup({
      locale: locale,
