  ...
  _createClass(SpikePrime, [{
    ...
    value: function _onConnect() {
      ...
      setTimeout(function () {
        ...
        _this2.sendRaw('import hub\r\nprint("PYTHON_AVAILABLE")\r\n');
        // Re-request initial state data
        _this2.sendCommand('trigger_current_state', {}, false);
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          try {
            ...
            this._parseAntonData(trimmedText);
          }
        }
      } catch (err) {
        _iterator.e(err);
      ...
      try {
        if (dataText.startsWith('SENSORS:')) {
          ...
          if (this._sensors.gestures.hasOwnProperty(gesture)) {
            ...
            setTimeout(function () {
              _this3._sensors.gestures[gesture] = false;
            }, 100);
          }
  ...
  _createClass(Scratch3SpikePrimeBlocks, [{
    ...
    value: function motorStart(args) {
      ...
      var promises = ports.map(function (port) {
        ...
        var antonCommand = _this7._peripheral.sendPythonCommand("import hub; hub.port.".concat(port, ".motor.pwm(").concat(Math.round(setting.speed * direction), ")"));
        return standardCommand.catch(function () {
          return antonCommand;
        });
      });
