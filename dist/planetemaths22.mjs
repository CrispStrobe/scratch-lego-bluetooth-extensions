...
// Translations are defined at the top so the class can access them.
...
var Scratch3PMBlocks = /*#__PURE__*/function () {
  function Scratch3PMBlocks(runtime) {
    ...
    // The constructor is kept simple to prevent errors on initial load.
  }
  _createClass(Scratch3PMBlocks, [{
    key: "_setupTranslations",
    value: function _setupTranslations() {
      // This is a private helper method to ensure translations are set up only when needed and when safe.
      var locale = 'en'; // Default to English
      if (this.runtime && this.runtime.getLocale) {
        locale = this.runtime.getLocale();
        console.log("%cPlaneteMaths Extension: Detected runtime locale: \"".concat(locale, "\""), 'color: green; font-weight: bold;');
      } else {
        console.warn('PlaneteMaths Extension: Runtime or getLocale not available. Falling back to English.');
      }
      formatMessage.setup({
        locale: locale,
    ...
    value: function getInfo() {
      ...
      // ✅ Translations are now set up safely inside getInfo.
      ...
      console.log('%cPlaneteMaths Extension: Returning info object:', 'color: blue; font-weight: bold;', info);
      return info;
    }
  }, {
    key: "add",
    ...
    value: function and(args) {
      ...
      var result = Cast.toBoolean(args.OPERAND1) && Cast.toBoolean(args.OPERAND2);
    ...
    value: function not(args) {
      ...
      var result = !Cast.toBoolean(args.OPERAND1);
