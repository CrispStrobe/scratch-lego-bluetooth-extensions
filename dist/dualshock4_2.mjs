...
var DualShock4 = /*#__PURE__*/function () {
  ...
  _createClass(DualShock4, [{
    ...
    value: function vibrate(motor, intensity, duration) {
      ...
      // Simplified vibration
      console.log("Vibrate ".concat(motor, " motor at ").concat(intensity, "% for ").concat(duration, "s"));
    ...
    value: function setLightBarColor(color) {
      if (!this.isConnected()) return Promise.resolve();
      console.log("Set light bar color to ".concat(color));
      return Promise.resolve();
    }
  }]);
  return DualShock4;
