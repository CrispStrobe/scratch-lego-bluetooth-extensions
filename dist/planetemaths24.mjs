...
var blockIconURI = 'data:image/svg+xml;base64,';
var extensionTranslations = {
  'en': {
    ...
    'pm.and': '[OPERATOR1] and [OPERATOR2]',
    'pm.or': '[OPERATOR1] or [OPERATOR2]',
    'pm.not': 'not [OPERATOR1]',
  ...
  'de': {
    ...
    'pm.pdecimale': '[choix1]-Nachkommastelle von [NUM1]',
    ...
    'pm.and': '[OPERATOR1] und [OPERATOR2]',
    'pm.or': '[OPERATOR1] oder [OPERATOR2]',
    'pm.not': 'nicht [OPERATOR1]',
    ...
    'text.vad': 'Abrundung von',
    'text.vae': 'Aufrundung von',
    'text.arrondi': 'Rundung von',
    'text.c1': 'Einer',
    'text.c2': 'Zehner',
    'text.c3': 'Hunderter',
    'text.c4': 'Tausender',
  ...
  'fr': {
    ...
    'pm.and': '[OPERATOR1] et [OPERATOR2]',
    'pm.or': '[OPERATOR1] ou [OPERATOR2]',
    'pm.not': 'non [OPERATOR1]',
    ...
    'pm.extract': 'extraire les caractères de [NUM1] à [NUM2] de [STRING]',
    'text.sqrt': '√',
    'text.cos': 'cos',
    'text.sin': 'sin',
    'text.tan': 'tan',
    ...
    'text.c3': 'centaines',
    'text.c4': 'milliers',
    'text.c5': 'dizaines de milliers',
    'text.c6': 'centaines de milliers',
    'text.c7': 'millions',
    'text.d1': 'dixièmes',
    'text.d2': 'centièmes',
    'text.d3': 'millièmes',
...
var Scratch3PMBlocks = /*#__PURE__*/function () {
  function Scratch3PMBlocks(runtime) {
    ...
    console.log('%cPlaneteMaths Extension: Constructor Called', 'color: green; font-weight: bold;');
  }
  _createClass(Scratch3PMBlocks, [{
    key: "getInfo",
    value: function getInfo() {
      console.log('%cPlaneteMaths Extension: getInfo() Called', 'color: blue; font-weight: bold;');

      // Set up translations if runtime is available. This allows for dynamic language switching.
      if (this.runtime && this.runtime.getLocale) {
        var locale = this.runtime.getLocale();
        console.log("%cPlaneteMaths Extension: Runtime locale is \"".concat(locale, "\". Setting up formatMessage."), 'color: green; font-weight: bold;');
        formatMessage.setup({
          locale: locale,
          translations: extensionTranslations
        });
      } else {
        console.warn('PlaneteMaths Extension: Runtime not available during getInfo. Translations will rely on translationMap.');
      }
      return {
        id: 'planetemaths',
        name: formatMessage({
        ...
        blocks: [{
          ...
          text: formatMessage({
            id: 'pm.and',
            default: '[OPERATOR1] and [OPERATOR2]'
          }),
          arguments: {
            OPERATOR1: {
          ...
          text: formatMessage({
            id: 'pm.or',
            default: '[OPERATOR1] or [OPERATOR2]'
          }),
          arguments: {
            OPERATOR1: {
              type: ArgumentType.BOOLEAN
    ...
    value: function add(args) {
      console.log('Executing "add" with args:', args);
      var num1 = Cast.toNumber(args.NUM1);
      var num2 = Cast.toNumber(args.NUM2);
      var result = num1 + num2;
      console.log("  > \"add\" result: ".concat(num1, " + ").concat(num2, " = ").concat(result));
      return result;
    }
  }, {
    key: "substract",
    value: function substract(args) {
      console.log('Executing "substract" with args:', args);
      var num1 = Cast.toNumber(args.NUM1);
      var num2 = Cast.toNumber(args.NUM2);
      var result = num1 - num2;
      console.log("  > \"substract\" result: ".concat(num1, " - ").concat(num2, " = ").concat(result));
      return result;
    }
  }, {
    key: "multiply",
    value: function multiply(args) {
      console.log('Executing "multiply" with args:', args);
      var num1 = Cast.toNumber(args.NUM1);
      var num2 = Cast.toNumber(args.NUM2);
      var result = num1 * num2;
      console.log("  > \"multiply\" result: ".concat(num1, " * ").concat(num2, " = ").concat(result));
      return result;
    }
  }, {
    key: "divide",
    value: function divide(args) {
      console.log('Executing "divide" with args:', args);
      var num1 = Cast.toNumber(args.NUM1);
      var num2 = Cast.toNumber(args.NUM2);
      var result = num1 / num2;
      console.log("  > \"divide\" result: ".concat(num1, " / ").concat(num2, " = ").concat(result));
      return result;
    }
  }, {
    key: "pow",
    value: function pow(args) {
      console.log('Executing "pow" with args:', args);
      var n = Cast.toNumber(args.NUM1);
      var m = Cast.toNumber(args.NUM2);
      var result = Math.pow(n, m);
      console.log("  > \"pow\" result: ".concat(n, " ^ ").concat(m, " = ").concat(result));
      return result;
    }
  }, {
    key: "gt",
    value: function gt(args) {
      console.log('Executing "gt" (<) with args:', args);
      var result = Cast.compare(args.NUM1, args.NUM2) < 0;
      console.log("  > \"gt\" result: ".concat(args.NUM1, " < ").concat(args.NUM2, " = ").concat(result));
      return result;
    }
  }, {
    key: "gte",
    value: function gte(args) {
      console.log('Executing "gte" (≤) with args:', args);
      var result = Cast.compare(args.NUM1, args.NUM2) <= 0;
      console.log("  > \"gte\" result: ".concat(args.NUM1, " \u2264 ").concat(args.NUM2, " = ").concat(result));
      return result;
    }
  }, {
    key: "equals",
    value: function equals(args) {
      console.log('Executing "equals" (=) with args:', args);
      var result = Cast.compare(args.NUM1, args.NUM2) === 0;
      console.log("  > \"equals\" result: ".concat(args.NUM1, " = ").concat(args.NUM2, " = ").concat(result));
      return result;
    }
  }, {
    key: "lt",
    value: function lt(args) {
      console.log('Executing "lt" (>) with args:', args);
      var result = Cast.compare(args.NUM1, args.NUM2) > 0;
      console.log("  > \"lt\" result: ".concat(args.NUM1, " > ").concat(args.NUM2, " = ").concat(result));
      return result;
    }
  }, {
    key: "lte",
    value: function lte(args) {
      console.log('Executing "lte" (≥) with args:', args);
      var result = Cast.compare(args.NUM1, args.NUM2) >= 0;
      console.log("  > \"lte\" result: ".concat(args.NUM1, " \u2265 ").concat(args.NUM2, " = ").concat(result));
      return result;
    }
  }, {
    key: "min",
    value: function min(args) {
      console.log('Executing "min" with args:', args);
      var result = Math.min(Cast.toNumber(args.NUM1), Cast.toNumber(args.NUM2));
      console.log("  > \"min\" result: ".concat(result));
      return result;
    }
  }, {
    key: "max",
    value: function max(args) {
      console.log('Executing "max" with args:', args);
      var result = Math.max(Cast.toNumber(args.NUM1), Cast.toNumber(args.NUM2));
      console.log("  > \"max\" result: ".concat(result));
      return result;
    }
  }, {
    key: "oppose",
    value: function oppose(args) {
      console.log('Executing "oppose" with args:', args);
      var result = -1 * Cast.toNumber(args.NUM1);
      console.log("  > \"oppose\" result: ".concat(result));
      return result;
    }
  }, {
    key: "inverse",
    value: function inverse(args) {
      console.log('Executing "inverse" with args:', args);
      var result = 1 / Cast.toNumber(args.NUM1);
      console.log("  > \"inverse\" result: ".concat(result));
      return result;
    }
  }, {
    key: "random",
    value: function random(args) {
      console.log('Executing "random" with args:', args);
      ...
      if (low === high) {
        result = low;
      } else if (Cast.isInt(args.NUM1) && Cast.isInt(args.NUM2)) {
        result = low + Math.floor(Math.random() * (high + 1 - low));
      } else {
        result = Math.random() * (high - low) + low;
      }
      console.log("  > \"random\" result between ".concat(low, " and ").concat(high, ": ").concat(result));
      return result;
    }
  }, {
    key: "and",
    value: function and(args) {
      console.log('Executing "and" with args:', args);
      var result = Cast.toBoolean(args.OPERATOR1) && Cast.toBoolean(args.OPERATOR2);
      console.log("  > \"and\" result: ".concat(result));
      return result;
    }
  }, {
    key: "or",
    value: function or(args) {
      console.log('Executing "or" with args:', args);
      var result = Cast.toBoolean(args.OPERATOR1) || Cast.toBoolean(args.OPERATOR2);
      console.log("  > \"or\" result: ".concat(result));
      return result;
    }
  }, {
    key: "not",
    value: function not(args) {
      console.log('Executing "not" with args:', args);
      var result = !Cast.toBoolean(args.OPERATOR1);
      console.log("  > \"not\" result: ".concat(result));
      return result;
    }
  }, {
    key: "pourcent",
    value: function pourcent(args) {
      console.log('Executing "pourcent" with args:', args);
      var result = Cast.toNumber(args.NUM1) / 100;
      console.log("  > \"pourcent\" result: ".concat(result));
      return result;
    }
  }, {
    key: "mathop",
    value: function mathop(args) {
      console.log('Executing "mathop" with args:', args);
      ...
      console.log("  > \"mathop\" (".concat(operator, ") result: ").concat(result));
      return result;
    }
  }, {
    key: "mathop2",
    value: function mathop2(args) {
      console.log('Executing "mathop2" with args:', args);
      var operator = Cast.toString(args.OPERATOR).toLowerCase();
      ...
      if (Number.isInteger(n1) && Number.isInteger(n2)) {
        ...
        switch (operator) {
          case 'pgcd':
            result = this.pgcd(n1, n2);
            break;
          case 'ppcm':
            result = n1 === 0 || n2 === 0 ? 0 : Math.abs(n1 * n2) / this.pgcd(n1, n2);
            break;
        }
        console.log("  > \"mathop2\" (".concat(operator, ") result: ").concat(result));
        return result;
      }
      console.log('  > "mathop2" returning empty string for non-integers.');
      return "";
    }
  }, {
    key: "mathopdiv",
    value: function mathopdiv(args) {
      console.log('Executing "mathopdiv" with args:', args);
      var operator = Cast.toString(args.OPERATOR).toLowerCase();
      var n1 = Cast.toNumber(args.NUM1);
      var n2 = Cast.toNumber(args.NUM2);
      if (Number.isInteger(n1) && Number.isInteger(n2)) {
        if (n2 === 0) {
          console.log('  > "mathopdiv" returning 0 due to division by zero.');
          return 0;
        }
        var resultVal = n1 % n2;
        if (resultVal / n2 < 0) resultVal += n2;
        var result = 0;
        switch (operator) {
          case 'reste':
            result = resultVal;
            break;
          case 'quotient':
            result = (n1 - resultVal) / n2;
            break;
        }
        console.log("  > \"mathopdiv\" (".concat(operator, ") result: ").concat(result));
        return result;
      }
      console.log('  > "mathopdiv" returning empty string for non-integers.');
      return "";
    }
  }, {
    key: "arrondis",
    value: function arrondis(args) {
      console.log('Executing "arrondis" with args:', args);
      ...
      switch (type) {
        case 'vad':
          result = Math.floor(n1 * p) / p;
          break;
        case 'vae':
          result = Math.ceil(n1 * p) / p;
          break;
        case 'arrondi':
          result = Math.round(n1 * p) / p;
          break;
      }
      console.log("  > \"arrondis\" (".concat(type, ") result: ").concat(result));
      return result;
    }
  }, {
    key: "chiffre_pentiere",
    value: function chiffre_pentiere(args) {
      console.log('Executing "chiffre_pentiere" with args:', args);
      var num = Math.trunc(Math.abs(Cast.toNumber(args.NUM1)));
      var digit = Cast.toNumber(args.choix1);
      var result = Math.trunc(num / Math.pow(10, digit)) % 10;
      console.log("  > \"chiffre_pentiere\" of ".concat(num, " at pos ").concat(digit, " = ").concat(result));
      return result;
    }
  }, {
    key: "chiffre_pdecimale",
    value: function chiffre_pdecimale(args) {
      console.log('Executing "chiffre_pdecimale" with args:', args);
      var num = Math.abs(Cast.toNumber(args.NUM1));
      var digit = Cast.toNumber(args.choix1);
      var result = Math.trunc(num * Math.pow(10, digit)) % 10;
      console.log("  > \"chiffre_pdecimale\" of ".concat(num, " at pos ").concat(digit, " = ").concat(result));
      return result;
    }
  }, {
    key: "multiple",
    value: function multiple(args) {
      console.log('Executing "multiple" with args:', args);
      ...
      if (Number.isInteger(n1) && Number.isInteger(n2)) {
        ...
        console.log("  > \"multiple\" (".concat(type, ") result: ").concat(result));
        return result;
      }
      console.log('  > "multiple" returning false for non-integers.');
      return false;
    }
  }, {
    key: "sommechiffres",
    value: function sommechiffres(args) {
      console.log('Executing "sommechiffres" with args:', args);
      ...
      if (Number.isInteger(value)) {
        ...
        console.log("  > \"sommechiffres\" of ".concat(originalValue, " = ").concat(somme));
        return somme;
      }
      console.log('  > "sommechiffres" returning empty string for non-integer.');
      return "";
    }
  }, {
    key: "pgcd",
    value: function pgcd(a, b) {
      return b ? this.pgcd(b, a % b) : Math.abs(a);
    }
  }, {
    key: "nombre_pi",
    value: function nombre_pi() {
      console.log('Executing "nombre_pi"');
      var result = Math.PI;
      console.log("  > \"nombre_pi\" result: ".concat(result));
      return result;
    }
  }, {
    key: "join",
    value: function join(args) {
      console.log('Executing "join" with args:', args);
      var result = Cast.toString(args.STRING1) + Cast.toString(args.STRING2);
      console.log("  > \"join\" result: \"".concat(result, "\""));
      return result;
    }
  }, {
    key: "letterOf",
    value: function letterOf(args) {
      console.log('Executing "letterOf" with args:', args);
      var index = Cast.toNumber(args.LETTER) - 1;
      var str = Cast.toString(args.STRING);
      if (index < 0 || index >= str.length) {
        console.log('  > "letterOf" index out of bounds, returning empty string.');
        return '';
      }
      var result = str.charAt(index);
      console.log("  > \"letterOf\" result: \"".concat(result, "\""));
      return result;
    }
  }, {
    key: "length",
    value: function length(args) {
      console.log('Executing "length" with args:', args);
      var result = Cast.toString(args.STRING).length;
      console.log("  > \"length\" result: ".concat(result));
      return result;
    }
  }, {
    key: "contains",
    value: function contains(args) {
      console.log('Executing "contains" with args:', args);
      var str1 = Cast.toString(args.STRING1).toLowerCase();
      var str2 = Cast.toString(args.STRING2).toLowerCase();
      var result = str1.includes(str2);
      console.log("  > \"contains\" result: ".concat(result));
      return result;
    }
  }, {
    key: "extract",
    value: function extract(args) {
      console.log('Executing "extract" with args:', args);
      var str = Cast.toString(args.STRING);
      var from = Cast.toNumber(args.NUM1) - 1;
      var to = Cast.toNumber(args.NUM2);
      if (from < 0 || to < from || from >= str.length) {
        console.log('  > "extract" returning empty string due to invalid range.');
        return '';
      }
      var result = str.substring(from, to);
      console.log("  > \"extract\" from index ".concat(from, " to ").concat(to, " result: \"").concat(result, "\""));
      return result;
    }
  }]);
