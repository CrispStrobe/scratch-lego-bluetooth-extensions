...
_spikeprimebtc.exports;
var hasRequired_spikeprimebtc;
function require_spikeprimebtc() {
  if (hasRequired_spikeprimebtc) return _spikeprimebtc.exports;
  ...
  (function (module, exports) {
    ...
    var JSONRPC = /*#__PURE__*/function () {
      ...
      return _createClass(JSONRPC, [{
        ...
        value: function _handleMessage(json) {
          if (json.jsonrpc !== '2.0') throw new Error("Bad JSON-RPC version: ".concat(json));
        ...
        value: function _handleRequest(json) {
          ...
          if (id !== null && typeof id !== 'undefined') {
            Promise.resolve(rawResult).then(function (result) {
              return _this2._sendResponse(id, result);
            }, function (error) {
              return _this2._sendResponse(id, null, error);
            });
          }
        }
      }, {
        ...
        value: function _handleResponse(json) {
          ...
          if (openRequest) {
            if (error) openRequest.reject(error);else openRequest.resolve(result);
          }
        }
      }, {
        key: "_sendResponse",
    ...
    var BT = /*#__PURE__*/function (_JSONRPC) {
      function BT(runtime, extensionId, peripheralOptions, connectCallback) {
        ...
        _this3 = _callSuper(this, BT);
        _this3._socket = runtime.getScratchLinkSocket('BT');
        _this3._socket.setOnOpen(_this3.requestPeripheral.bind(_this3));
        _this3._socket.setOnError(_this3._handleRequestError.bind(_this3));
        _this3._socket.setOnClose(_this3.handleDisconnectError.bind(_this3));
        _this3._socket.setHandleMessage(_this3._handleMessage.bind(_this3));
        _this3._sendMessage = _this3._socket.sendMessage.bind(_this3._socket);
        _this3._availablePeripherals = {};
        _this3._connectCallback = connectCallback;
        _this3._connected = false;
        _this3._resetCallback = resetCallback;
        _this3._discoverTimeoutID = null;
        _this3._extensionId = extensionId;
        _this3._peripheralOptions = peripheralOptions;
        _this3._messageCallback = messageCallback;
        _this3._runtime = runtime;
        _this3._socket.open();
        return _this3;
      }
      ...
      return _createClass(BT, [{
        ...
        value: function requestPeripheral() {
          ...
          this.sendRemoteRequest('discover', this._peripheralOptions).catch(function (e) {
            return _this4._handleRequestError(e);
          });
        }
      }, {
        ...
        value: function connectPeripheral(id) {
          ...
          this.sendRemoteRequest('connect', params).then(function () {
            ...
            _this5._runtime.emit(_this5._runtime.constructor.PERIPHERAL_CONNECTED);
            _this5._connectCallback();
          }).catch(function (e) {
            return _this5._handleRequestError(e);
          });
        }
      }, {
        key: "disconnect",
        ...
        value: function sendMessage(options) {
          ...
          return this.sendRemoteRequest('send', options).catch(function (e) {
            return _this6.handleDisconnectError(e);
          });
        }
      }, {
        key: "didReceiveCall",
      ...
      return _createClass(SpikePrime, [{
          ...
          try {
            if (dataText.startsWith('SENSORS:')) {
              ...
              if (this._sensors.gestures.hasOwnProperty(gesture)) {
                ...
                setTimeout(function () {
                  _this0._sensors.gestures[gesture] = false;
                }, 100);
              }
        ...
        value: function _parseEventResponse(response) {
          ...
          if (gestureMap[response.p]) {
            ...
            setTimeout(function () {
              _this1._sensors.gestures[gestureMap[response.p]] = false;
            }, 100);
          }
        }
      }]);
  ...
  })(_spikeprimebtc, _spikeprimebtc.exports);
  return _spikeprimebtc.exports;
}
