...
require('./lib/color');
var setupTranslations = require('./lib/setup-translations');
  ...
  return _createClass(Scratch3SpikePrimeBlocks, [{
    ...
    value: function _motorRunForDegrees(ports, direction, degrees) {
      ...
      var promises = ports.map(function (port) {
        ...
        var aCommand = _this5._peripheral.sendPythonCommand("import hub; hub.port.".concat(port, ".motor.run_for_degrees(").concat(Math.floor(degrees), ", ").concat(setting.speed * direction, ")"));
    ...
    value: function _motorRunTimed(ports, direction, seconds) {
      ...
      var promises = ports.map(function (port) {
        ...
        var aCommand = _this6._peripheral.sendPythonCommand("import hub; hub.port.".concat(port, ".motor.run_for_time(").concat(Math.floor(seconds * 1000), ", ").concat(setting.speed * direction, ")"));
        return standardCommand.catch(function () {
          return aCommand;
        });
      });
    ...
    value: function motorStart(args) {
      ...
      var promises = ports.map(function (port) {
        ...
        var aCommand = _this7._peripheral.sendPythonCommand("import hub; hub.port.".concat(port, ".motor.pwm(").concat(Math.round(setting.speed * direction), ")"));
        return standardCommand.catch(function () {
          return aCommand;
        });
      });
    ...
    value: function motorStop(args) {
      ...
      var promises = ports.map(function (port) {
        ...
        var aCommand = _this8._peripheral.sendPythonCommand("import hub; hub.port.".concat(port, ".motor.stop()"));
        return standardCommand.catch(function () {
          return aCommand;
        });
      });
    ...
    value: function getRelativePosition(args) {
      ...
      var aData = this._peripheral._sensors.motorPositions[port];
      if (aData) {
    ...
    value: function displayText(args) {
      ...
      var aCommand = this._peripheral.sendPythonCommand("import hub; hub.display.show(\"".concat(text.replace(/"/g, '\\"'), "\")"));
      return standardCommand.catch(function () {
        return aCommand;
      });
    }
    ...
    value: function displayImage(args) {
      ...
      //  extended approach  
      var aImage = symbol.replace(/1/g, '9').replace(/0/g, '_').match(/.{5}/g).join(':');
      var aCommand = this._peripheral.sendPythonCommand("import hub; hub.display.show(hub.Image(\"".concat(aImage, "\"))"));
      return standardCommand.catch(function () {
        return aCommand;
      });
    }
    ...
    value: function displayClear() {
      ...
      var aCommand = this._peripheral.sendPythonCommand('import hub; hub.display.show(" ")');
      return standardCommand.catch(function () {
        return aCommand;
      });
    }
    ...
    value: function setPixel(args) {
      ...
      var aCommand = this._peripheral.sendPythonCommand("import hub; hub.display.pixel(".concat(x, ", ").concat(y, ", ").concat(Math.round(brightness * 9 / 100), ")"));
      return standardCommand.catch(function () {
        return aCommand;
      });
    }
    ...
    value: function setCenterButtonColor(args) {
      ...
      var aCommand = this._peripheral.sendPythonCommand("import hub; hub.led(".concat(colorValue, ")"));
      return standardCommand.catch(function () {
        return aCommand;
      });
    }
    ...
    value: function playBeep(args) {
      ...
      var aCommand = this._peripheral.sendPythonCommand("import hub; hub.sound.beep(".concat(frequency, ", ").concat(duration, ", hub.sound.SOUND_SIN)"));
      return standardCommand.catch(function () {
        return aCommand;
      });
    }
