...
_legoluigi.exports;
var hasRequired_legoluigi;
function require_legoluigi() {
  if (hasRequired_legoluigi) return _legoluigi.exports;
  hasRequired_legoluigi = 1;
  (function (module, exports) {
    ...
    var Scratch3LegoLuigiBlocks = /*#__PURE__*/function (_MarioBaseBlocks) {
      function Scratch3LegoLuigiBlocks(runtime) {
        ...
        _this7 = _callSuper(this, Scratch3LegoLuigiBlocks, [new Hub(runtime, Scratch3LegoLuigiBlocks.EXTENSION_ID, 0x44)]);
