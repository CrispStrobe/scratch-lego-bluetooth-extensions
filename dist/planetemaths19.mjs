...
// Note: Using the shorter icon URI from your later attempts as it's cleaner.
...
var Scratch3PMBlocks = /*#__PURE__*/function () {
  ...
  _createClass(Scratch3PMBlocks, [{
    ...
    value: function getInfo() {
      ...
      var info = {
        ...
        blocks: [{
          ...
          opcode: 'pourcent',
          // ✅ *** THE FIX IS HERE ***: A single '%' must be escaped as '%%'
          text: formatMessage({
            id: 'pm.pourcent',
            default: '[NUM1] %%'
          }),
    ...
    value: function sommechiffres(args) {
      ...
      console.log('  > "sommechiffres" returning 0 for non-integer.');
      return 0;
    }
  }, {
    key: "pgcd",
    value: function pgcd(a, b) {
      // This is a helper, so no direct log unless needed for deep debug
    ...
    value: function extract(args) {
      ...
      var to = Cast.toNumber(args.NUM2); // substring's second arg is the end index, not length
    ...
    value: function setupTranslations() {
      // This is the old way of doing translations. It should still work.
      console.log('PlaneteMaths Extension: setupTranslations() called.');
      var localeSetup = formatMessage.setup();
      console.log("  > Detected locale: ".concat(localeSetup.locale));
      if (localeSetup && localeSetup.translations[localeSetup.locale]) {
        ...
        console.log('  > No existing translation table found to merge into.');
      }
    }
  }]);
