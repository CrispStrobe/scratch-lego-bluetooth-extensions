...
let extensionURL = 'https://cdn.jsdelivr.net/gh/CrispStrobe/scratch-lego-bluetooth-extensions@master/dist/spikeprime_btc.mjs';
...
class Scratch3SpikePrimeBlocks {
    ...
    getInfo() {
        ...
        return {
            ...
            name: formatMessage({ id: 'spikeprime.title', default: 'SPIKE Prime Ultimate' }),
            ...
            blocks: [
                // ===== MOVEMENT CONTROLS (NEW) =====
                {
                    ...
                    text: formatMessage({ id: 'spikeprime.setMovementMotors', default: 'set movement motors [PORT_A] and [PORT_B]' }),
                ...
                {
                    opcode: 'moveForward',
                    text: formatMessage({ id: 'spikeprime.moveForward', default: 'move [DIRECTION] for [VALUE] [UNIT]' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                ...
                {
                    opcode: 'steer',
                    text: formatMessage({ id: 'spikeprime.steer', default: 'start steering [STEERING]' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                ...
                {
                    opcode: 'startTank',
                    text: formatMessage({ id: 'spikeprime.startTank', default: 'start tank drive left [LEFT_SPEED] right [RIGHT_SPEED]' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                ...
                },
                {
                    ...
                    text: formatMessage({ id: 'spikeprime.setMovementSpeed', default: 'set movement speed to [SPEED]%' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                ...
                {
                    opcode: 'stopMovement',
                    text: formatMessage({ id: 'spikeprime.stopMovement', default: 'stop movement' }),
                    blockType: BlockType.COMMAND
                },
                '---',
                // ===== MOTOR CONTROL =====
                {
                    opcode: 'motorRunFor',
                    text: formatMessage({ id: 'spikeprime.motorRunFor', default: '[PORT] run [DIRECTION] for [VALUE] [UNIT]' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                ...
                },
                {
                    ...
                    text: formatMessage({ id: 'spikeprime.motorRunToPosition', default: '[PORT] run to position [POSITION] degrees' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                ...
                {
                    opcode: 'motorStart',
                    text: formatMessage({ id: 'spikeprime.motorStart', default: '[PORT] start motor [DIRECTION]' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                        PORT: { type: ArgumentType.STRING, menu: 'MULTIPLE_PORT', defaultValue: 'A' },
                        DIRECTION: { type: ArgumentType.NUMBER, menu: 'DIRECTION', defaultValue: 1 }
                ...
                {
                    opcode: 'motorStop',
                    text: formatMessage({ id: 'spikeprime.motorStop', default: '[PORT] stop motor' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                        PORT: { type: ArgumentType.STRING, menu: 'MULTIPLE_PORT', defaultValue: 'A' }
                    }
                },
                {
                    ...
                    text: formatMessage({ id: 'spikeprime.motorSetSpeed', default: '[PORT] set speed to [SPEED] %' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                        PORT: { type: ArgumentType.STRING, menu: 'MULTIPLE_PORT', defaultValue: 'A' },
                ...
                },
                {
                    ...
                    text: formatMessage({ id: 'spikeprime.motorSetStopAction', default: '[PORT] set stop action to [ACTION]' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                ...
                {
                    opcode: 'getPosition',
                    text: formatMessage({ id: 'spikeprime.getPosition', default: '[PORT] position' }),
                ...
                // ===== MOTOR ENHANCEMENTS =====
                {
                    ...
                    text: formatMessage({ id: 'spikeprime.getRelativePosition', default: '[PORT] relative position' }),
                    blockType: BlockType.REPORTER,
                    arguments: {
                        PORT: { type: ArgumentType.STRING, menu: 'PORT', defaultValue: 'A' }
                    }
                },
                {
                    ...
                    text: formatMessage({ id: 'spikeprime.getAbsolutePosition', default: '[PORT] absolute position' }),
                    blockType: BlockType.REPORTER,
                    arguments: {
                        PORT: { type: ArgumentType.STRING, menu: 'PORT', defaultValue: 'A' }
                    }
                ...
                {
                    opcode: 'getSpeed',
                    text: formatMessage({ id: 'spikeprime.getSpeed', default: '[PORT] speed (deg/s)' }),
                    blockType: BlockType.REPORTER,
                    arguments: {
                        PORT: { type: ArgumentType.STRING, menu: 'PORT', defaultValue: 'A' }
                    }
                },
                {
                    ...
                    text: formatMessage({ id: 'spikeprime.resetMotorPosition', default: 'reset [PORT] motor position to [POSITION]' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                        PORT: { type: ArgumentType.STRING, menu: 'PORT', defaultValue: 'A' },
                ...
                {
                    opcode: 'displayText',
                    text: formatMessage({ id: 'spikeprime.displayText', default: 'write [TEXT]' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                ...
                {
                    opcode: 'displayImage',
                    text: formatMessage({ id: 'spikeprime.displayImage', default: 'turn on [MATRIX]' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                        MATRIX: { type: ArgumentType.MATRIX, defaultValue: '1101111011000001000101110' }
                    }
                },
                {
                    opcode: 'displayPattern',
                    text: formatMessage({ id: 'spikeprime.displayPattern', default: 'display pattern [PATTERN]' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                ...
                {
                    opcode: 'displayClear',
                    text: formatMessage({ id: 'spikeprime.displayClear', default: 'turn off pixels' }),
                    blockType: BlockType.COMMAND
                },
                {
                    opcode: 'setPixel',
                    text: formatMessage({ id: 'spikeprime.setPixel', default: 'set pixel [X] [Y] to [BRIGHTNESS] %' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                ...
                },
                {
                    ...
                    text: formatMessage({ id: 'spikeprime.rotateDisplay', default: 'rotate display [ANGLE] degrees' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                ...
                },
                {
                    ...
                    text: formatMessage({ id: 'spikeprime.setCenterButtonColor', default: 'set center button to [COLOR]' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                ...
                {
                    opcode: 'getAngle',
                    text: formatMessage({ id: 'spikeprime.getAngle', default: '[AXIS] angle' }),
                    blockType: BlockType.REPORTER,
                    arguments: {
                        AXIS: { type: ArgumentType.STRING, menu: 'AXIS', defaultValue: 'pitch' }
                    }
                },
                {
                    opcode: 'getGyroRate',
                    text: formatMessage({ id: 'spikeprime.getGyroRate', default: 'gyro rate [AXIS] (deg/s)' }),
                    blockType: BlockType.REPORTER,
                    arguments: {
                        AXIS: { type: ArgumentType.STRING, menu: 'AXIS', defaultValue: 'yaw' }
                    }
                },
                {
                    opcode: 'getFilteredGyroRate',
                    text: formatMessage({ id: 'spikeprime.getFilteredGyroRate', default: 'filtered gyro rate [AXIS] (deg/s)' }),
                    blockType: BlockType.REPORTER,
                    arguments: {
                        AXIS: { type: ArgumentType.STRING, menu: 'AXIS', defaultValue: 'yaw' }
                    }
                },
                {
                    ...
                    text: formatMessage({ id: 'spikeprime.getAcceleration', default: 'acceleration [AXIS] (milli-g)' }),
                    blockType: BlockType.REPORTER,
                    arguments: {
                        AXIS: { type: ArgumentType.STRING, menu: 'AXIS_XYZ', defaultValue: 'x' }
                    }
                },
                {
                    opcode: 'getFilteredAcceleration',
                    text: formatMessage({ id: 'spikeprime.getFilteredAcceleration', default: 'filtered acceleration [AXIS] (milli-g)' }),
                    blockType: BlockType.REPORTER,
                    arguments: {
                        AXIS: { type: ArgumentType.STRING, menu: 'AXIS_XYZ', defaultValue: 'x' }
                    }
                ...
                {
                    opcode: 'resetYaw',
                    text: formatMessage({ id: 'spikeprime.resetYaw', default: 'reset yaw angle' }),
                    blockType: BlockType.COMMAND
                },
                {
                    opcode: 'presetYaw',
                    text: formatMessage({ id: 'spikeprime.presetYaw', default: 'preset yaw to [ANGLE] degrees' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                ...
                // ===== 3X3 LED COLOR MATRIX =====
                {
                    ...
                    text: formatMessage({ id: 'spikeprime.setMatrix3x3ColorGrid', default: 'set [PORT] 3x3 colors: [P1][P2][P3] [P4][P5][P6] [P7][P8][P9]' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                        PORT: { type: ArgumentType.STRING, menu: 'PORT', defaultValue: 'A' },
                ...
                },
                {
                    ...
                    text: formatMessage({ id: 'spikeprime.setMatrix3x3BrightnessGrid', default: 'set [PORT] 3x3 brightness: [B1][B2][B3] [B4][B5][B6] [B7][B8][B9]' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                        PORT: { type: ArgumentType.STRING, menu: 'PORT', defaultValue: 'A' },
                ...
                },
                {
                    ...
                    text: formatMessage({ id: 'spikeprime.setMatrix3x3PixelEmoji', default: 'set [PORT] 3x3 pixel [X],[Y] to [COLOR] brightness [BRIGHTNESS]' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                        PORT: { type: ArgumentType.STRING, menu: 'PORT', defaultValue: 'A' },
                ...
                },
                {
                    ...
                    text: formatMessage({ id: 'spikeprime.setMatrix3x3Custom', default: 'set [PORT] 3x3 custom pattern [PATTERN]' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                        PORT: { type: ArgumentType.STRING, menu: 'PORT', defaultValue: 'A' },
                ...
                },
                {
                    ...
                    text: formatMessage({ id: 'spikeprime.generateMatrix3x3Code', default: 'generate 3x3 code for pattern [PATTERN]' }),
                    blockType: BlockType.REPORTER,
                    arguments: {
                        PATTERN: { type: ArgumentType.STRING, defaultValue: 'r8 .1 r8\nr6 r10 r6\n.1 r8 .1' }
                    }
                },
                {
                    opcode: 'setMatrix3x3SolidColor',
                    text: formatMessage({ id: 'spikeprime.setMatrix3x3SolidColor', default: 'set [PORT] 3x3 matrix all [COLOR] brightness [BRIGHTNESS]' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                        PORT: { type: ArgumentType.STRING, menu: 'PORT', defaultValue: 'A' },
                        COLOR: { type: ArgumentType.STRING, menu: 'MATRIX_COLOR_EMOJI', defaultValue: '🔴' },
                ...
                },
                {
                    ...
                    text: formatMessage({ id: 'spikeprime.setMatrix3x3Level', default: 'set [PORT] 3x3 battery level to [LEVEL]' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                        PORT: { type: ArgumentType.STRING, menu: 'PORT', defaultValue: 'A' },
                        LEVEL: { type: ArgumentType.NUMBER, defaultValue: 5 }
                    }
                },
                {
                    opcode: 'setMatrix3x3Transition',
                    text: formatMessage({ id: 'spikeprime.setMatrix3x3Transition', default: 'set [PORT] 3x3 transition [EFFECT]' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                        PORT: { type: ArgumentType.STRING, menu: 'PORT', defaultValue: 'A' },
                        EFFECT: { type: ArgumentType.STRING, menu: 'MATRIX_3X3_TRANSITION', defaultValue: 'none' }
                    }
                },
                {
                    opcode: 'clearMatrix3x3',
                    text: formatMessage({ id: 'spikeprime.clearMatrix3x3', default: 'clear [PORT] 3x3 matrix' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                        PORT: { type: ArgumentType.STRING, menu: 'PORT', defaultValue: 'A' }
                    }
                ...
                // ===== ENHANCED GESTURES =====
                {
                    ...
                    text: formatMessage({ id: 'spikeprime.whenGesture', default: 'when hub [GESTURE]' }),
                    arguments: {
                ...
                },
                {
                    ...
                    text: formatMessage({ id: 'spikeprime.isGesture', default: 'hub [GESTURE]?' }),
                    arguments: {
                        GESTURE: { type: ArgumentType.STRING, menu: 'GESTURE', defaultValue: 'tapped' }
                    }
                },
                {
                    ...
                    text: formatMessage({ id: 'spikeprime.getOrientation', default: 'orientation' }),
                    blockType: BlockType.REPORTER
                },
                '---',
                // ===== SOUND SYSTEM =====
                {
                    opcode: 'playHubSound',
                    text: formatMessage({ id: 'spikeprime.playHubSound', default: 'play hub sound [SOUND]' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                ...
                {
                    opcode: 'playBeep',
                    text: formatMessage({ id: 'spikeprime.playBeep', default: 'beep [FREQUENCY] Hz for [DURATION] ms' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                ...
                {
                    opcode: 'playNote',
                    text: formatMessage({ id: 'spikeprime.playNote', default: 'play note [NOTE] for [SECS] seconds' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                ...
                {
                    opcode: 'playWaveBeep',
                    text: formatMessage({ id: 'spikeprime.playWaveBeep', default: 'beep [WAVEFORM] [FREQUENCY] Hz for [DURATION] ms' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                ...
                {
                    opcode: 'setVolume',
                    text: formatMessage({ id: 'spikeprime.setVolume', default: 'set volume to [VOLUME]%' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                ...
                {
                    opcode: 'stopSound',
                    text: formatMessage({ id: 'spikeprime.stopSound', default: 'stop all sounds' }),
                    blockType: BlockType.COMMAND
                },
                '---',
                // ===== STATUS & TEMPERATURE =====
                {
                    ...
                    text: formatMessage({ id: 'spikeprime.getBatteryLevel', default: 'battery level %' }),
                    blockType: BlockType.REPORTER
                },
                {
                    opcode: 'getBatteryTemperature',
                    text: formatMessage({ id: 'spikeprime.getBatteryTemperature', default: 'battery temperature' }),
                    blockType: BlockType.REPORTER
                },
                {
                    opcode: 'getHubTemperature',
                    text: formatMessage({ id: 'spikeprime.getHubTemperature', default: 'hub temperature' }),
                    blockType: BlockType.REPORTER
                },
                '---',
                // ===== TIMER FUNCTIONALITY =====
                {
                    opcode: 'getTimer',
                    text: formatMessage({ id: 'spikeprime.getTimer', default: 'timer' }),
                    blockType: BlockType.REPORTER
                },
                {
                    opcode: 'resetTimer',
                    text: formatMessage({ id: 'spikeprime.resetTimer', default: 'reset timer' }),
                    blockType: BlockType.COMMAND
                },
                '---',
                // ===== SENSOR BLOCKS =====
                {
                    opcode: 'getDistance',
                    text: formatMessage({ id: 'spikeprime.getDistance', default: '[PORT] distance' }),
                    blockType: BlockType.REPORTER,
                    arguments: {
                        PORT: { type: ArgumentType.STRING, menu: 'PORT', defaultValue: 'A' }
                    }
                },
                {
                    ...
                    text: formatMessage({ id: 'spikeprime.setDistanceLights', default: 'set [PORT] distance lights [TL] [TR] [BL] [BR]' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                        PORT: { type: ArgumentType.STRING, menu: 'PORT', defaultValue: 'A' },
                ...
                {
                    opcode: 'getColor',
                    text: formatMessage({ id: 'spikeprime.getColor', default: '[PORT] color' }),
                    blockType: BlockType.REPORTER,
                    arguments: {
                        PORT: { type: ArgumentType.STRING, menu: 'PORT', defaultValue: 'A' }
                    }
                },
                {
                    ...
                    text: formatMessage({ id: 'spikeprime.getReflection', default: '[PORT] reflection' }),
                    blockType: BlockType.REPORTER,
                    arguments: {
                        PORT: { type: ArgumentType.STRING, menu: 'PORT', defaultValue: 'A' }
                    }
                },
                {
                    ...
                    text: formatMessage({ id: 'spikeprime.getAmbientLight', default: '[PORT] ambient light' }),
                    blockType: BlockType.REPORTER,
                    arguments: {
                        PORT: { type: ArgumentType.STRING, menu: 'PORT', defaultValue: 'A' }
                    }
                ...
                {
                    opcode: 'getForce',
                    text: formatMessage({ id: 'spikeprime.getForce', default: '[PORT] force' }),
                    blockType: BlockType.REPORTER,
                    arguments: {
                        PORT: { type: ArgumentType.STRING, menu: 'PORT', defaultValue: 'A' }
                    }
                },
                {
                    ...
                    text: formatMessage({ id: 'spikeprime.isForceSensorPressed', default: '[PORT] force sensor pressed?' }),
                    blockType: BlockType.BOOLEAN,
                    arguments: {
                        PORT: { type: ArgumentType.STRING, menu: 'PORT', defaultValue: 'A' }
                    }
                ...
                // ===== EVENT-BASED SENSOR BLOCKS =====
                {
                    opcode: 'whenColor',
                    blockType: BlockType.HAT,
                    text: formatMessage({ id: 'spikeprime.whenColor', default: 'when [PORT] sees [COLOR]' }),
                    arguments: {
                        PORT: { type: ArgumentType.STRING, menu: 'PORT', defaultValue: 'A' },
                ...
                },
                {
                    opcode: 'isColor',
                    blockType: BlockType.BOOLEAN,
                    text: formatMessage({ id: 'spikeprime.isColor', default: '[PORT] sees [COLOR]?' }),
                    arguments: {
                        PORT: { type: ArgumentType.STRING, menu: 'PORT', defaultValue: 'A' },
                        COLOR: { type: ArgumentType.STRING, menu: 'COLOR', defaultValue: 'red' }
                    }
                },
                {
                    ...
                    blockType: BlockType.HAT,
                    text: formatMessage({ id: 'spikeprime.whenForceSensor', default: 'when [PORT] is [STATE]' }),
                    arguments: {
                        PORT: { type: ArgumentType.STRING, menu: 'PORT', defaultValue: 'A' },
                ...
                // ===== BUTTON ENHANCEMENTS =====
                {
                    ...
                    text: formatMessage({ id: 'spikeprime.isButtonPressed', default: '[BUTTON] button pressed?' }),
                    blockType: BlockType.BOOLEAN,
                    arguments: {
                ...
                },
                {
                    ...
                    blockType: BlockType.HAT,
                    text: formatMessage({ id: 'spikeprime.whenButtonPressed', default: 'when [BUTTON] button pressed' }),
                    arguments: {
                        BUTTON: { type: ArgumentType.STRING, menu: 'BUTTON', defaultValue: 'center' }
                    }
                },
                ...
                // ===== PYTHON REPL =====
                {
                    ...
                    text: formatMessage({ id: 'spikeprime.runReplCommand', default: 'run Python REPL: [CODE]' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                        CODE: { type: ArgumentType.STRING, defaultValue: 'print("Hello REPL!")' }
                    }
                },
                {
                    opcode: 'getReplOutput',
                    text: formatMessage({ id: 'spikeprime.getReplOutput', default: 'REPL output' }),
                    blockType: BlockType.REPORTER
                },
                {
                    opcode: 'clearReplOutput',
                    text: formatMessage({ id: 'spikeprime.clearReplOutput', default: 'clear REPL output' }),
                    blockType: BlockType.COMMAND
                },
                {
                    opcode: 'getReplHistory',
                    text: formatMessage({ id: 'spikeprime.getReplHistory', default: 'REPL command [INDEX]' }),
                    blockType: BlockType.REPORTER,
                    arguments: {
                ...
                // ===== ADVANCED PYTHON COMMANDS =====
                {
                    ...
                    text: formatMessage({ id: 'spikeprime.runPythonCommand', default: 'run Python: [CODE]' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                        CODE: { type: ArgumentType.STRING, defaultValue: 'print("Hello World")' }
                    }
                },
                {
                    opcode: 'runHubCommand',
                    text: formatMessage({ id: 'spikeprime.runHubCommand', default: 'run hub command: [CODE]' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                ...
                {
                    opcode: 'exitScript',
                    text: formatMessage({ id: 'spikeprime.exitScript', default: 'exit Python script' }),
                    blockType: BlockType.COMMAND
                }
            ],
            menus: {
                ...
                MOTOR_UNIT: {
                    ...
                    items: [
                        { text: formatMessage({ id: 'spikeprime.menu.moveUnit.rotations', default: 'rotations' }), value: 'rotations' },
                        { text: formatMessage({ id: 'spikeprime.menu.moveUnit.degrees', default: 'degrees' }), value: 'degrees' },
                        { text: formatMessage({ id: 'spikeprime.menu.moveUnit.seconds', default: 'seconds' }), value: 'seconds' }
                    ]
                },
                AXIS: { 
                    acceptReporters: false,
                    items: [
                        { text: formatMessage({ id: 'spikeprime.menu.axis.pitch', default: 'pitch' }), value: 'pitch' },
                        { text: formatMessage({ id: 'spikeprime.menu.axis.roll', default: 'roll' }), value: 'roll' },
                        { text: formatMessage({ id: 'spikeprime.menu.axis.yaw', default: 'yaw' }), value: 'yaw' }
                    ]
                },
                AXIS_XYZ: {
                    acceptReporters: false,
                ...
                GESTURE: {
                    acceptReporters: false,
                    items: [
                        { text: formatMessage({ id: 'spikeprime.menu.gesture.tapped', default: 'tapped' }), value: 'tapped' },
                        { text: formatMessage({ id: 'spikeprime.menu.gesture.doubletapped', default: 'doubletapped' }), value: 'doubletapped' },
                        { text: formatMessage({ id: 'spikeprime.menu.gesture.shake', default: 'shake' }), value: 'shake' },
                        { text: formatMessage({ id: 'spikeprime.menu.gesture.freefall', default: 'freefall' }), value: 'freefall' }
                    ]
                },
                HUB_SOUND: {
                    acceptReporters: false,
                ...
                WAVEFORM: {
                    acceptReporters: false,
                    items: [
                        { text: formatMessage({ id: 'spikeprime.menu.waveform.sin', default: 'sin' }), value: 'sin' },
                        { text: formatMessage({ id: 'spikeprime.menu.waveform.square', default: 'square' }), value: 'square' },
                        { text: formatMessage({ id: 'spikeprime.menu.waveform.triangle', default: 'triangle' }), value: 'triangle' },
                        { text: formatMessage({ id: 'spikeprime.menu.waveform.sawtooth', default: 'sawtooth' }), value: 'sawtooth' }
                    ]
                },
                BUTTON: {
                    acceptReporters: false,
                    items: [
                        { text: formatMessage({ id: 'spikeprime.menu.button.left', default: 'left' }), value: 'left' },
                        { text: formatMessage({ id: 'spikeprime.menu.button.center', default: 'center' }), value: 'center' },
                        { text: formatMessage({ id: 'spikeprime.menu.button.right', default: 'right' }), value: 'right' },
                        { text: formatMessage({ id: 'spikeprime.menu.button.connect', default: 'connect' }), value: 'connect' }
                    ]
                },
                MOVE_DIRECTION: {
                    acceptReporters: false,
                    items: [
                        { text: formatMessage({ id: 'spikeprime.menu.direction.forward', default: 'forward' }), value: 'forward' },
                        { text: formatMessage({ id: 'spikeprime.menu.direction.backward', default: 'backward' }), value: 'backward' }
                    ]
                },
                MOVE_UNIT: {
                    acceptReporters: false,
                    items: [
                        { text: formatMessage({ id: 'spikeprime.menu.moveUnit.cm', default: 'cm' }), value: 'cm' },
                        { text: formatMessage({ id: 'spikeprime.menu.moveUnit.in', default: 'in' }), value: 'in' },
                        { text: formatMessage({ id: 'spikeprime.menu.moveUnit.rotations', default: 'rotations' }), value: 'rotations' },
                        { text: formatMessage({ id: 'spikeprime.menu.moveUnit.degrees', default: 'degrees' }), value: 'degrees' },
                        { text: formatMessage({ id: 'spikeprime.menu.moveUnit.seconds', default: 'seconds' }), value: 'seconds' }
                    ]
                ...
                STOP_ACTION: {
                    acceptReporters: false,
                    items: [
                        { text: formatMessage({ id: 'spikeprime.menu.stopAction.coast', default: 'coast' }), value: 'coast' },
                        { text: formatMessage({ id: 'spikeprime.menu.stopAction.brake', default: 'brake' }), value: 'brake' },
                        { text: formatMessage({ id: 'spikeprime.menu.stopAction.hold', default: 'hold' }), value: 'hold' }
                    ]
                },
                COLOR: {
                    acceptReporters: true,
                    items: [
                        { text: formatMessage({ id: 'spikeprime.menu.color.red', default: 'red' }), value: 'red' },
                        { text: formatMessage({ id: 'spikeprime.menu.color.green', default: 'green' }), value: 'green' },
                        { text: formatMessage({ id: 'spikeprime.menu.color.blue', default: 'blue' }), value: 'blue' },
                        { text: formatMessage({ id: 'spikeprime.menu.color.yellow', default: 'yellow' }), value: 'yellow' },
                        { text: formatMessage({ id: 'spikeprime.menu.color.cyan', default: 'cyan' }), value: 'cyan' },
                        { text: formatMessage({ id: 'spikeprime.menu.color.magenta', default: 'magenta' }), value: 'magenta' },
                        { text: formatMessage({ id: 'spikeprime.menu.color.white', default: 'white' }), value: 'white' },
                        { text: formatMessage({ id: 'spikeprime.menu.color.black', default: 'black' }), value: 'black' }
                    ]
                },
                FORCE_STATE: {
                    acceptReporters: false,
                    items: [
                        { text: formatMessage({ id: 'spikeprime.menu.forceState.pressed', default: 'pressed' }), value: 'pressed' },
                        { text: formatMessage({ id: 'spikeprime.menu.forceState.hardPressed', default: 'hard pressed' }), value: 'hard pressed' },
                        { text: formatMessage({ id: 'spikeprime.menu.forceState.released', default: 'released' }), value: 'released' }
                    ]
                },
                MATRIX_COLOR_EMOJI: {
                    acceptReporters: false,
    ...
    moveForward(args) {
        ...
        if (unit === 'cm') {
            ...
            const rotations = value / 6.93; // 1 rotation â‰ˆ 6.93 inches
            return this._peripheral.sendPythonCommand(`motors.move(${rotations * dirMultiplier}, 'rotations', speed=${speed})`);
        } else {
